...
const FAQ = [
  ...
  { q: 'Πόσο κοστίζει;', a: `Τέσσερα πακέτα, από ${fe(PLANS.solo.priceMonthly, 2)} τον μήνα για ένα ακίνητο με όλα τα φορολογικά ως ${fe(PLANS.office.priceMonthly, 2)} για απεριόριστα, και ${EXTRA_PROPERTY_PRICE} € για κάθε επιπλέον ακίνητο. Κάθε λογαριασμός ξεκινά με ${TRIAL_DAYS} ημέρες δοκιμή χωρίς κάρτα, και μετά συνεχίζεις δωρεάν με ένα ακίνητο.` },
