...
const FAQ = [
  ...
  { q: 'Πόσο κοστίζει;', a: 'Το πρώτο ακίνητο δεν σου κοστίζει ποτέ τίποτα: όλες οι δυνατότητες, χωρίς κάρτα. Κάθε νέος λογαριασμός ξεκινά με 30 ημέρες δωρεάν δοκιμή του πλάνου Ιδιοκτήτης, χωρίς κάρτα και χωρίς αυτόματη χρέωση — όταν λήξει, συνεχίζεις κανονικά στο Δωρεάν. Για περισσότερα ακίνητα, το πλάνο Ιδιοκτήτης κοστίζει 9,90 € τον μήνα (ή 99 € τον χρόνο, δύο μήνες δώρο) για έως 3 ακίνητα. Το πλάνο Επαγγελματίας κοστίζει 24,90 € τον μήνα (ή 249 € τον χρόνο, δύο μήνες δώρο) για έως 15 ακίνητα, με ομαδική διαχείριση. Αλλάζεις ή ακυρώνεις όποτε θέλεις· οι τιμές περιλαμβάνουν ΦΠΑ.' },
