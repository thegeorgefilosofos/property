...
const FAQ = [
  { q: 'Πόσο κοστίζει;', a: `Τέσσερα πακέτα: από ${fe(PLANS.solo.priceMonthly)} τον μήνα για ένα ακίνητο, με τα φορολογικά εργαλεία και τον προσωπικό βοηθό μέσα, ως ${fe(PLANS.office.priceMonthly)} τον μήνα για απεριόριστα ακίνητα και χρήστες. Με ετήσια συνδρομή πληρώνεις έως ${monthsSaved} μήνες λιγότερους και το μηνιαίο κόστος πέφτει.` },
  ...
  { q: 'Δουλεύει στο κινητό;', a: 'Φυσικά: προσαρμόζεται σε κινητό, tablet και υπολογιστή, και η σάρωση αποδίδει καλύτερα με την κάμερα του κινητού ή του tablet. Εγκαθίσταται και στην αρχική οθόνη σαν εφαρμογή. Ξεχωριστή για iOS και Android έρχεται σύντομα· γράφεσαι στη λίστα αναμονής του Λογαριασμού.' },
