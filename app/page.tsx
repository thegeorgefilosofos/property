...
// Ο τιμοκατάλογος γράφεται ΜΙΑ φορά, στο lib/billing/plans.ts. Η απάντηση του
// FAQ τον είχε αντιγραμμένο με το χέρι και είχε ήδη ξεμείνει: ανέφερε δύο από τα
// τρία πλάνα επί πληρωμή και καθόλου τη χρέωση επιπλέον ακινήτου.
const PAID_PLANS_TEXT = PLAN_ORDER
...
const FAQ = [
  ...
  { q: 'Πόσο κοστίζει;', a: `Το πρώτο ακίνητο είναι δωρεάν για πάντα. Τα πλάνα επί πληρωμή: ${PAID_PLANS_TEXT}. Κάθε επιπλέον ακίνητο ${EXTRA_PROPERTY_PRICE} € τον μήνα. Κάθε νέος λογαριασμός ξεκινά με ${TRIAL_DAYS} ημέρες δοκιμή. Οι τιμές ισχύουν για την Ελλάδα και περιλαμβάνουν ΦΠΑ. Η χρέωση με κάρτα ενεργοποιείται σύντομα.` },
