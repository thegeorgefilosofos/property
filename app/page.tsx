...
function FaqList({ list }: { list: { q: string; a: string }[] }) {
  return (
    <>
      {list.map((f) => (
        <details key={f.q} className="lp-faq" style={{ borderTop: `1px solid ${LINE}` }}>
    ...
    <div className="lp-root" style={{ color: TEXT, minHeight: '100vh', fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      <style>{`
        ...
        /* ═══ Η ΣΤΟΙΧΙΣΗ «ΠΕΡΑ ΠΕΡΑ» ΕΦΥΓΕ, ΚΑΙ ΕΙΝΑΙ Η ΣΩΣΤΗ ΑΠΟΦΑΣΗ ═══════════
           ...
           ολόκληρο το μέτρο της ενότητας, όσο και ο τίτλος από πάνω. Και ανέβηκαν
           σε μέγεθος: στα δεκαπέντε, μια γραμμή 1044 εικονοστοιχείων κουβαλά
           εκατόν τριάντα χαρακτήρες, δηλαδή διπλάσιους από το άνετο. Στα
           δεκαεννιά η ίδια γραμμή πέφτει κοντά στους εκατό, οι παράγραφοι γίνονται
           δύο σειρές η καθεμία, και το μπλοκ διαβάζεται ως δήλωση αντί για τοίχο. */
        .lp-why { max-width: 1044px; display: flex; flex-direction: column; gap: clamp(14px, 1.6vw, 18px); }
        .lp-why p {
          margin: 0; font-size: clamp(16px, 1.7vw, 19px); line-height: 1.6;
      ...
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP_ACT }}>
        ...
        {/* ═══ ΤΕΣΣΕΡΙΣ ΠΑΡΑΓΡΑΦΟΙ, ΠΕΡΑ ΠΕΡΑ, ΧΩΡΙΣ ΣΤΗΛΕΣ ══════════════════════
            ...
            ζυγιστεί, οπότε δεν υπάρχει τίποτα να ξεστοιχιστεί· και σε πλάτος
            χιλίων εικονοστοιχείων η στοίχιση δουλεύει όπως στο βιβλίο, με τον
            συλλαβισμό να κλείνει τα κενά. */}
        <div className="lp-why">
          ...
          <p>
            Ε2, Δήλωση Μίσθωσης, ΕΝΦΙΑ, τεκμαρτή έκπτωση, κοινόχρηστα, αναπροσαρμογή μισθώματος,
            δηλώσεις βραχυχρόνιας: καθένα με τη δική του προθεσμία, και η ευθύνη πάντα πάνω σου.
          </p>
          <p>
          ...
          <p>
            ...
            παραστατικό καταχωρείται με μια φωτογραφία. Ο φάκελος του λογιστή αποστέλλεται με ένα κλικ.
          </p>
        </div>
