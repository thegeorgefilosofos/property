...
const FEATURES = [
  ...
  { t: 'Βοηθός που σκέφτεται στα ελληνικά', d: 'Προγραμματίζει, ενημερώνει, συμβουλεύει. Έχει μπροστά του τα δικά σου νούμερα — ενοίκια, δαπάνες, προθεσμίες — και απαντά με βάση αυτά, όχι με γενικότητες. Με φωνή, αν βολεύει.', i: 'M21 12a8 8 0 0 1-8 8H8l-5 3 1.4-4.2A8 8 0 1 1 21 12M8.5 12h.01M12 12h.01M15.5 12h.01' },
