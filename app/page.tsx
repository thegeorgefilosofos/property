...
const FAQ = [
  ...
  // ΔΥΟ ΑΠΑΝΤΗΣΕΙΣ ΠΟΥ ΑΝΑΙΡΟΥΣΑΝ Η ΜΙΑ ΤΗΝ ΑΛΛΗ. Τα ψιλά γράμματα του
  // τιμοκαταλόγου έλεγαν «ακυρώνεις πριν λήξει και δεν πληρώνεις τίποτα» —
  // δηλαδή στη λήξη χρεώνεσαι. Εδώ έλεγε «αν δεν διαλέξεις πακέτο, ο
  // λογαριασμός μένει σε αναμονή» — δηλαδή στη λήξη ΔΕΝ χρεώνεσαι. Ο
  // αναγνώστης δεν μπορούσε να ξέρει ποιο από τα δύο ισχύει, και το ένα από τα
  // δύο του κόστιζε χρήματα. Το πακέτο επιλέγεται στην εγγραφή, η κάρτα
  // δηλώνεται τότε, άρα η συνδρομή ξεκινά στη λήξη: αυτό γράφεται, μία φορά.
  { q: 'Τι γίνεται όταν λήξει η δοκιμή;', a: 'Στη λήξη ξεκινά αυτόματα η συνδρομή του πακέτου που διάλεξες, με την κάρτα που δήλωσες στην εγγραφή. Αν ακυρώσεις πριν από τη λήξη δεν χρεώνεσαι τίποτα: ο λογαριασμός μένει σε αναμονή και τα δεδομένα σου παραμένουν ανέπαφα, όσο κι αν αργήσεις να επιστρέψεις.' },
    ...
    <div className="lp-root" style={{ color: TEXT, minHeight: '100vh', fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP }}>
        ...
        <p style={{ fontSize: 13, color: FAINT, margin: '22px 0 0', maxWidth: 620, lineHeight: 1.6 }}>
          Κάθε πακέτο ξεκινά με {TRIAL_DAYS} ημέρες δωρεάν δοκιμή. Δηλώνεις κάρτα στην εγγραφή και δεν χρεώνεσαι όσο διαρκεί: ακυρώνεις με ένα κλικ πριν λήξει και δεν πληρώνεις τίποτα. Χωρίς δέσμευση, χωρίς κρυφές χρεώσεις και χωρίς ποινή αν φύγεις· οι τιμές περιλαμβάνουν ΦΠΑ.
        </p>
      </section>
