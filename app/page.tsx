    ...
    <div className="lp-root" style={{ color: TEXT, minHeight: '100vh', fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      <style>{`
        ...
        /* ═══ Η ΣΤΟΙΧΙΣΗ «ΠΕΡΑ ΠΕΡΑ» ΕΦΥΓΕ, ΚΑΙ ΕΙΝΑΙ Η ΣΩΣΤΗ ΑΠΟΦΑΣΗ ═══════════
           ...
           ΤΑ 80ch ΚΡΑΤΟΥΝ ΚΑΙ ΤΑ ΔΥΟ. Η γραμμή πέφτει γύρω στους 90 χαρακτήρες
           και το μπλοκ μένει φαρδύ: το όριο δαγκώνει μόνο στα πολύ φαρδιά
           παράθυρα και αφήνει δεξιά ένα κενό μικρότερο από μία λέξη ανά γραμμή.
           Οι δύο στήλες ΔΕΝ επανέρχονται· ο λόγος που γύρισαν πίσω παραπάνω, ότι
           η πρόταση κόβεται στη μέση, ισχύει ακόμη.
        ...
        .lp-why p {
          margin: 0; font-size: 16px; line-height: 1.6; max-width: 80ch;
          color: var(--text-secondary); text-wrap: pretty;
        }
      ...
      <section id="pricing" className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP }}>
        ...
        {/* ΤΑ ΨΙΛΑ ΓΡΑΜΜΑΤΑ ΣΕ ΔΥΟ ΣΤΗΛΕΣ, ΚΑΙ ΟΙ ΔΥΟ ΠΡΟΗΓΟΥΜΕΝΕΣ ΜΟΡΦΕΣ ΗΤΑΝ ΛΑΘΟΣ.
            Πρώτα ήταν κλεισμένα σε 620 μέσα σε στήλη 1044 και διαβάζονταν ως
            μισοτελειωμένα: τρεις κοντές σειρές και δεξιά τους κενό όσο και το
            κείμενο. Λύθηκε αφήνοντάς τα να πιάσουν όλο το πλάτος· τότε η
            μέτρηση έδειξε τι κόστισε: 153 ΧΑΡΑΚΤΗΡΕΣ ΑΝΑ ΓΡΑΜΜΗ σε φορητό, όπου
            το μάτι χάνει τη σειρά γυρίζοντας αριστερά. Το πρόβλημα δεν λύθηκε,
            άλλαξε άκρη. Οι δύο στήλες (.fineprint) δίνουν και τα δύο: όλο το
            μέτρο της ενότητας, χωρίς κενό δεξιά, με γραμμή γύρω στους 75. */}
        <p className="fineprint" style={{ fontSize: 13, color: FAINT, margin: '22px 0 0', lineHeight: 1.6 }}>
