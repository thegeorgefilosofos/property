  ...
  return (
    <div className="lp-root" style={{ color: TEXT, minHeight: '100vh', fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      <style>{`
        ...
        .lp-why { max-width: 1044px; display: flex; flex-direction: column; gap: 14px; }
        .lp-why p {
          margin: 0; font-size: clamp(15px, 1.5vw, 16.5px); line-height: 1.7;
          color: var(--text-secondary);
          text-align: justify; text-align-last: left; hyphens: auto; text-wrap: pretty;
        }
        /* Σε στενή οθόνη η γραμμή είναι πολύ κοντή για στοίχιση: ούτε ο
           συλλαβισμός σώζει γραμμή τριάντα χαρακτήρων. */
        @media (max-width: 700px) { .lp-why p { text-align: left; hyphens: none; } }
