...
const FEATURES = [
  { t: 'Σύγκριση ρεύματος και ασφάλειας', d: 'Συγκρίνεις τα τιμολόγια όλων των παρόχων και τις ασφάλειες του ακινήτου σου και βλέπεις πόσα γλιτώνεις πριν αποφασίσεις.', i: 'M3 12h4l3 8 4-16 3 8h4' },
  ...
  { t: 'Προϋπολογισμός και αποδόσεις', d: 'Καταγράφεις δαπάνες, ορίζεις στόχους και βλέπεις πόσα αφήνει καθαρά κάθε ακίνητο.', i: 'M12 2v20M17 7H9.5a2.5 2.5 0 0 0 0 5h5a2.5 2.5 0 0 1 0 5H7' },
  { t: 'Μίσθωση με σιγουριά', d: 'Ζυγίζεις βραχυχρόνια και μακροχρόνια μίσθωση με τα δικά σου νούμερα, είτε ξεκινάς τώρα είτε εκμισθώνεις ήδη.', i: 'M3 21h18M5 21V7l8-4v18M13 9h6v12M9 9h.01M9 13h.01M9 17h.01' },
  { t: 'Φορολογία 2026', d: 'Γνωρίζεις έγκαιρα τις υποχρεώσεις και τις ευκαιρίες σου με βάση την ισχύουσα φορολογία. Δεν αντικαθιστά τον λογιστή σου, σε κρατά όμως πάντα προετοιμασμένο.', i: 'M9 7h6M9 11h6M9 15h4M5 3h14v18l-3-2-2 2-2-2-2 2-3-2z' },
...
const TICKER = [
  ...
  'Ε2 έτοιμο για τον λογιστή', 'Δεδομένα στην ΕΕ · GDPR',
];
...
const SECURITY = [
  ...
  { t: 'Δεδομένα στην ΕΕ · GDPR', d: 'Αποθήκευση σε ευρωπαϊκά κέντρα δεδομένων, πλήρως συμβατή με τον GDPR.', i: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20M2 12h20M12 2c3 3 3 17 0 20M12 2c-3 3-3 17 0 20' },
];
...
export default async function Landing() {
  ...
  return (
    <div className="lp-root" style={{ color: TEXT, minHeight: '100vh', fontFamily: "'Inter',-apple-system,sans-serif", overflowX: 'clip', position: 'relative' }}>
      ...
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: 'clamp(44px, 7vw, 84px)' }}>
        <SectionHead over="Δες το μόνος σου" title="Πόσο σου αποδίδει πραγματικά;" sub="Βάλε τα νούμερα του ακινήτου σου. Ο ίδιος υπολογισμός που τρέχει και μέσα στην εφαρμογή, με τη φορολογία ενοικίων του 2026." />
        <LandingCalculator />
      </section>
      ...
      <footer style={{ borderTop: `1px solid ${LINE}`, position: 'relative', zIndex: 1 }}>
        <div style={{ ...wrap, padding: 'clamp(32px, 5vw, 48px) clamp(20px, 5vw, 48px)' }}>
          ...
          <div style={{ paddingTop: 20, borderTop: `1px solid ${LINE}`, display: 'flex', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap', fontSize: 12.5, color: FAINT }}>
            ...
            <span>Δεδομένα στην ΕΕ · Συμβατό με τον GDPR</span>
          </div>
        </div>
      </footer>
    </div>
