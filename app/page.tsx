...
// για δύο γραμμές είναι ΕΞΗΝΤΑ. Και οι τέσσερις κάθονται ανάμεσα σε 48 και 51:
// δύο γραμμές παντού, με τη διαφορά τους μέσα σε τρεις χαρακτήρες. Ο φρουρός
// κρατά το όριο· όποιος γράψει μακρύτερα θα βρει κόκκινο.
const STATS = [
  { n: '7',  u: 'είδη εγγράφων',     l: 'Λογαριασμός, μισθωτήριο, ΕΝΦΙΑ και ασφαλιστήριο.' },
  { n: '11', u: 'πάροχοι ρεύματος',  l: 'Τα κύρια τιμολόγιά τους, ελεγμένα τον Ιούλιο 2026.' },
  { n: '16', u: 'ασφαλιστικές',      l: 'Κατοικία και επαγγελματική στέγη, κάλυψη με κάλυψη.' },
  { n: '4',  u: 'κλιμάκια ενοικίων', l: '15, 25, 35 και 45%, για τα εισοδήματα του 2026.' },
];
...
const AUDIENCE = [
  ...
  },
  {
    ...
    t: 'Πολλά ακίνητα',
    d: 'Ποιο αποδίδει και ποιο κοστίζει.',
  },
  {
    tag: PLANS.agency.name,
    t: 'Ακίνητα άλλων',
    d: 'Λογοδοτείς για κάθε ευρώ και μέρα.',
  },
  {
