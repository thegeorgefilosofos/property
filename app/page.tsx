...
const FAQ = [
  ...
  { q: 'Τι γίνεται όταν λήξει η δοκιμή;', a: 'Δεν ζητάμε κάρτα στην εγγραφή και καμία χρέωση δεν γίνεται, ούτε στη δοκιμή ούτε μετά: η χρέωση συνδρομών δεν έχει ενεργοποιηθεί ακόμη. Στη λήξη ο λογαριασμός μένει σε αναμονή, τα ακίνητα και τα δεδομένα σου παραμένουν όπως είναι, και τα εργαλεία των πακέτων ξεκλειδώνουν όταν ενεργοποιηθεί η συνδρομή. Το πακέτο που διάλεξες στην εγγραφή είναι εκείνο που θα ισχύσει τότε.' },
  ...
  return (
    <div className="lp-root" style={{ color: TEXT, minHeight: '100vh', fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      {/* ── ΔΟΜΗΜΕΝΑ ΔΕΔΟΜΕΝΑ ───────────────────────────────────────────────
             ...
             • `offers` με τιμή — η χρέωση δεν έχει ενεργοποιηθεί. Τιμή σε
               δομημένα δεδομένα διαβάζεται ως «αγόρασέ το τώρα», και δεν
               υπάρχει ταμείο. Μπαίνει μαζί με τον webhook πληρωμής.
