  ...
  return (
    <div className="lp-root" style={{ color: TEXT, minHeight: '100vh', fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      <style>{`
        ...
        @media (max-width: 560px) { .lp-why p { text-align: left; } }
      ...
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP_ACT }}>
        ...
        {/* ΟΙ ΔΥΟ ΣΤΗΛΕΣ ΕΙΝΑΙ ΖΥΓΙΣΜΕΝΕΣ ΣΕ ΧΑΡΑΚΤΗΡΕΣ, ΟΧΙ ΣΤΟ ΜΑΤΙ. Αριστερά
            309, δεξιά 318: με στοίχιση «πέρα πέρα» και ίδιο πλάτος στήλης, οι
            δύο πλευρές κλείνουν στην ίδια σειρά. Όταν η μία ήταν κατά ένα τρίτο
            μικρότερη, η ενότητα φαινόταν μισοτελειωμένη όσο σωστά κι αν ήταν
            στοιχισμένη η καθεμία χωριστά. Ό,τι προστεθεί στη μία, μπαίνει και
            στην άλλη. */}
