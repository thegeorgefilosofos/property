...
const FEATURES = [
  ...
  { t: 'Δάνειο χωρίς εκπλήξεις', d: 'Δόσεις, επιτόκια και έξοδα μεταβίβασης πάνω στα δικά σου στοιχεία, με έλεγχο αν δικαιούσαι το «Σπίτι μου ΙΙ».', i: 'M3 21h18M5 21V7l8-4v18M19 21V11l-6-4' },
  { t: 'Αποδόσεις και σενάρια μίσθωσης', d: 'Καθαρή απόδοση μετά τον φόρο, και η βραχυχρόνια μίσθωση δίπλα στη μακροχρόνια, στα δικά σου νούμερα.', i: 'M12 2v20M17 7H9.5a2.5 2.5 0 0 0 0 5h5a2.5 2.5 0 0 1 0 5H7' },
...
const AUDIENCE = [
  ...
  // να αφήσει πίσω της παλιά ταμπέλα σε αυτή τη σελίδα.
  {
    ...
    d: 'Θέλεις να ξέρεις τι πληρώνεις, τι εισπράττεις και τι λήγει, χωρίς να τα κρατάς όλα εσύ στο μυαλό σου.',
    k: ['Ε2 προσυμπληρωμένο για τον λογιστή', 'ΕΝΦΙΑ με έκπτωση και δόσεις', 'Ειδοποίηση πριν από κάθε προθεσμία'],
  },
  {
    tag: PLANS.owner.name,
    t: 'Δύο και πάνω ακίνητα',
    d: 'Έχεις περισσότερα από ένα και δεν ξέρεις ποιο σου αποδίδει. Το φύλλο Excel δεν σου το λέει ποτέ αυτό.',
    k: ['Σύγκριση ακινήτων μεταξύ τους', 'Διπλάσιο πακέτο ερωτήσεων στη Νόα', 'Το mobile app 15 ημέρες νωρίτερα'],
  },
  {
    tag: PLANS.agency.name,
    t: 'Διαχειριστής, μεσίτης ή λογιστής',
    d: 'Διαχειρίζεσαι ξένα ακίνητα και λογοδοτείς σε τρίτους. Χρειάζεσαι τάξη κι έναν τόπο για όλα.',
    k: ['Πελατολόγιο και χαρτοφυλάκιο', 'Ομάδα με ρόλους και δικαιώματα', 'Αναφορές με τη δική σου επωνυμία'],
  },
  {
    tag: PLANS.office.name,
    t: 'Γραφείο με χαρτοφυλάκιο',
    d: 'Τα ακίνητα είναι πολλά για να μετριούνται και οι συνεργάτες περισσότεροι από όσους χωράει ένα όριο.',
    k: ['Απεριόριστα ακίνητα και χρήστες', 'Κάθε νέα δυνατότητα πρώτα σε εσένα', 'Άμεση επικοινωνία μαζί μας'],
  },
];
    ...
    <div className="lp-root" style={{ color: TEXT, minHeight: '100vh', fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      <style>{`
        ...
        /* ═══ ΟΙ ΤΕΣΣΕΡΙΣ ΚΑΡΤΕΣ ΕΥΘΥΓΡΑΜΜΙΖΟΝΤΑΙ ΓΡΑΜΜΗ ΠΡΟΣ ΓΡΑΜΜΗ ═══════
           ...
           Το subgrid το λύνει σωστά: οι τέσσερις σειρές (ταμπέλα, τίτλος,
           περιγραφή, λίστα) ορίζονται ΜΙΑ φορά στο πλέγμα και κάθε κάρτα τις
           δανείζεται. Ό,τι κι αν γράψει κανείς μέσα, οι τέσσερις τίτλοι είναι
           σε μία ευθεία και τα σημάδια ελέγχου ξεκινούν στην ίδια γραμμή.
        ...
        <div className="lp-split" style={{ background: PANEL, border: `1px solid ${LINE}`, borderRadius: 14, padding: 'clamp(24px, 3vw, 38px)', display: 'grid', gridTemplateColumns: 'minmax(0, 0.82fr) minmax(0, 1.18fr)', gap: 'clamp(24px, 3vw, 44px)', alignItems: 'start' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '22px 26px' }}>
            ...
            <p style={{ gridColumn: '1 / -1', fontSize: 13, color: FAINT, lineHeight: 1.6, margin: 0 }}>
              Σχεδιασμένο σύμφωνα με τον Κανονισμό GDPR. Οι συμβάσεις με τους παρόχους εκτός ΕΕ ολοκληρώνονται πριν από την εμπορική κυκλοφορία.
            </p>
          </div>
        </div>
      </section>
