...
const FEATURES = [
  { t: 'Σύγκριση ρεύματος και ασφάλειας', d: 'Συγκρίνεις σε πραγματικό χρόνο τιμολόγια όλων των παρόχων και των ασφαλιστικών εταιρειών, για να λάβεις την καλύτερη απόφαση για την περιουσία σου.', i: 'M3 12h4l3 8 4-16 3 8h4' },
  ...
  { t: 'Όλα σε ένα σημείο', d: 'Έγγραφα, ημερολόγιο, υπενθυμίσεις και αρχείο, οργανωμένα και κρυπτογραφημένα. Τέλος στους σκόρπιους φακέλους.', i: 'M4 4h6l2 2h8v12H4zM4 10h16' },
];
...
const FAQ = [
  ...
  { q: 'Ο βοηθός καταλαβαίνει και μιλάει ελληνικά;', a: 'Ναι. Μιλάει φυσικά ελληνικά, με κείμενο ή προφορικά, και σου απαντά με ανθρώπινη φωνή. Του δίνεις όνομα και φωνή όπως θέλεις. Απαντά πάντα με βάση τα δικά σου δεδομένα: τα ακίνητα, τις δαπάνες, τις μισθώσεις και τις προθεσμίες σου. Για ό,τι χρειάζεται νομική ή λογιστική γνώμη, σε παραπέμπει στον κατάλληλο επαγγελματία.' },
...
const TICKER = [
  ...
  'Ε2 έτοιμο για τον λογιστή', 'Δεδομένα στην ΕΕ · Κανονισμός GDPR',
];
...
const STATS = [
  ...
  { n: 'ΕΕ', l: 'δεδομένα κρυπτογραφημένα, συμβατά με τον Κανονισμό GDPR' },
];
    ...
    <div className="lp-root" style={{ color: TEXT, minHeight: '100vh', fontFamily: "'Inter',-apple-system,sans-serif", overflowX: 'clip', position: 'relative' }}>
      ...
      <section className="lp-hero" style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ ...wrap, position: 'relative', zIndex: 1, paddingTop: 'clamp(64px, 9vw, 112px)', paddingBottom: 'clamp(48px, 7vw, 84px)', textAlign: 'center' }}>
          ...
          <div className="lp-rise-4" style={{ marginTop: 18, fontSize: 12.5, color: 'rgba(255,255,255,.45)' }}>Χωρίς κάρτα · Το πρώτο ακίνητο πάντα δωρεάν · Συμβατό με τον Κανονισμό GDPR</div>
      ...
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: 'clamp(44px, 7vw, 84px)' }}>
        <SectionHead over="Δες το μόνος σου" title="Πόσο σου αποδίδει πραγματικά;" sub="Βάλε τα δεδομένα του ακινήτου σου. Ο υπολογιστής σου δείχνει τις πραγματικές αποδόσεις, σύμφωνα και με την τρέχουσα φορολογία ενοικίων (2026)." />
        <LandingCalculator />
      </section>
      ...
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, padding: 'clamp(20px, 3vw, 32px) clamp(20px, 5vw, 48px) clamp(44px, 7vw, 84px)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: 16, maxWidth: 1040, margin: '0 auto', alignItems: 'stretch' }}>
          ...
          {/* Ιδιοκτήτης */}
          <PlanCard
            name="Ιδιοκτήτης" nameColor={ACCENT} sub="Για ιδιοκτήτες χαρτοφυλακίου ακινήτων και εκμισθωτές μακροχρόνιας ή βραχυχρόνιας περιόδου"
          ...
          {/* Επαγγελματίας */}
          <PlanCard
            name="Επαγγελματίας" nameColor={TEXT} sub="Για διαχειριστές, μεσιτικά γραφεία και λογιστές με ομάδα"
            price="18,90 €" per="τον μήνα" note={<>ή <strong style={{ color: TEXT }}>149 € τον χρόνο</strong></>} discount="−34%"
      ...
      <footer style={{ borderTop: `1px solid ${LINE}`, position: 'relative', zIndex: 1 }}>
        <div style={{ ...wrap, padding: 'clamp(32px, 5vw, 48px) clamp(20px, 5vw, 48px)' }}>
          ...
          <div style={{ paddingTop: 20, borderTop: `1px solid ${LINE}`, display: 'flex', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap', fontSize: 12.5, color: FAINT }}>
            ...
            <span>Δεδομένα στην ΕΕ · Συμβατό με τον Κανονισμό GDPR</span>
          </div>
        </div>
      </footer>
    </div>
