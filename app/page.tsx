  ...
  return (
    <div className="lp-root" style={{ color: TEXT, minHeight: '100vh', fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP_ACT }}>
        ...
        {/* ═══ Η ΕΝΟΤΗΤΑ ΕΛΕΓΕ ΤΙ ΔΕΝ ΚΑΝΟΥΝ ΤΑ ΑΛΛΑ, ΟΧΙ ΤΙ ΚΑΝΕΙ ΑΥΤΗ ══════
            «Κανένα γενικό εργαλείο δεν ξέρει… δεν πρόκειται να μάθουν ποτέ»:
            τρεις σειρές για το Excel και τις σημειώσεις, και ο επισκέπτης
            έφτανε στο τέλος χωρίς να έχει διαβάσει ΤΙ κάνει το Property OS.
            Η υποτίμηση εργαλείων που ο αναγνώστης χρησιμοποιεί σήμερα δεν τον
            πείθει· του λέει ότι έκανε λάθος επιλογή, και αμύνεται.
            Τώρα λέει τη δουλειά: τι αναλαμβάνει, τι δίνει στον λογιστή, τι
            βλέπει ο ιδιοκτήτης. Μηδέν σύγκριση με τρίτους. */}
        <div className="lp-eyebrow">Πώς δημιουργήθηκε</div>
        <p style={{ fontSize: 'clamp(20px, 2.4vw, 27px)', lineHeight: 1.3, color: 'var(--text-primary)', margin: '0 0 clamp(20px, 2.4vw, 32px)', letterSpacing: '-0.02em', fontWeight: 450 }}>
          Η ελληνική φορολογία των ακινήτων, γραμμένη μέσα στην εφαρμογή.
        </p>
        <div className="lp-why">
          <div>
            <p style={{ fontSize: 15, lineHeight: 1.7, color: MUTED, margin: '0 0 18px' }}>
              Το Ε2, η Δήλωση Πληροφοριακών Στοιχείων Μίσθωσης, ο ΕΝΦΙΑ και οι προθεσμίες τους ακολουθούν
              κανόνες που αλλάζουν κάθε χρόνο. Το Property OS τους κρατά σε μία πηγή και τους εφαρμόζει
              μόνο του: κάθε ημερομηνία, κάθε ευρώ και κάθε παραστατικό του ακινήτου σε ένα σημείο, με τον
              υπολογισμό ήδη έτοιμο και την προθεσμία ήδη στο ημερολόγιο.
            </p>
            <p style={{ fontSize: 15, lineHeight: 1.7, color: MUTED, margin: 0 }}>
              Φωτογραφίζεις ένα παραστατικό και καταχωρείται με ημερομηνία, ποσό και κατηγορία. Ο βοηθός
              τεχνητής νοημοσύνης απαντά με τα δικά σου νούμερα και την ισχύουσα νομοθεσία, όχι με γενικές
              οδηγίες.
            </p>
          </div>
          <div>
            <p style={{ fontSize: 15, lineHeight: 1.7, color: MUTED, margin: '0 0 18px' }}>
              Ο λογιστής σου παίρνει έτοιμο φάκελο: λογιστικό ημερολόγιο, παραστατικά και αντιστοίχιση με το
              ελληνικό λογιστικό σχέδιο, στη μορφή που δουλεύει. Εσύ βλέπεις την απόδοση κάθε ακινήτου, πού
              πηγαίνει το κάθε ευρώ και τι αλλάζει η επόμενη κίνηση.
            </p>
            <p style={{ fontSize: 15, lineHeight: 1.7, color: MUTED, margin: '0 0 18px' }}>
              Για ιδιοκτήτες και επαγγελματίες που θέλουν ακρίβεια στα νούμερα. Εσύ κρατάς τις αποφάσεις·
              τα υπόλοιπα τα κρατά η εφαρμογή.
            </p>
