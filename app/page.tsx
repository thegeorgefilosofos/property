    ...
    <div className="lp-root" style={{ color: TEXT, minHeight: '100vh', fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      <section id="pricing" className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP }}>
        ...
        <p style={{ fontSize: 13, color: FAINT, margin: '22px 0 0', lineHeight: 1.6 }}>
          Κάθε πακέτο ξεκινά με {TRIAL_DAYS} ημέρες δωρεάν δοκιμή, και τίποτα δεν αλλάζει χωρίς να το ξέρεις: το πακέτο το διαλέγεις εσύ από την αρχή, ανάλογα με τα ακίνητα και τα εργαλεία που χρειάζεσαι. Χωρίς δέσμευση, χωρίς κρυφές χρεώσεις και χωρίς ποινή αν φύγεις· αναβαθμίζεις, αλλάζεις ή σταματάς όποτε θέλεις χωρίς επιπλέον επιβάρυνση. Δωρεάν είναι μόνο η δοκιμή και οι μήνες που κερδίζεις από συστάσεις· οι τιμές αφορούν καταναλωτές στην Ελλάδα και περιλαμβάνουν ΦΠΑ.
        </p>
      </section>
