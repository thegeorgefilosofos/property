...
const FEATURES = [
  ...
  { t: 'Βοηθός στα ελληνικά', d: 'Συγκρίνει και προτείνει με βάση τα δικά σου ενοίκια και δαπάνες, όχι με γενικές συμβουλές. Και με φωνή, αν θέλεις.', i: 'M21 12a8 8 0 0 1-8 8H8l-5 3 1.4-4.2A8 8 0 1 1 21 12M8.5 12h.01M12 12h.01M15.5 12h.01' },
  { t: 'Πάροχοι και ασφάλιση', d: 'Τιμολόγια 11 παρόχων ρεύματος και 16 ασφαλιστικών εταιρειών, από επίσημα στοιχεία που επαληθεύονται τακτικά.', i: 'M3 12h4l3 8 4-16 3 8h4' },
  { t: 'Δάνειο χωρίς εκπλήξεις', d: 'Δόσεις, επιτόκια και έξοδα μεταβίβασης πάνω στα δικά σου στοιχεία, μαζί με έλεγχο αν δικαιούσαι το «Σπίτι μου ΙΙ».', i: 'M3 21h18M5 21V7l8-4v18M19 21V11l-6-4' },
  { t: 'Αποδόσεις και σενάρια μίσθωσης', d: 'Καθαρή απόδοση μετά τον φόρο, και η βραχυχρόνια δίπλα στη μακροχρόνια μίσθωση, με τα δικά σου νούμερα.', i: 'M12 2v20M17 7H9.5a2.5 2.5 0 0 0 0 5h5a2.5 2.5 0 0 1 0 5H7' },
  ...
  { t: 'Έγγραφα και προθεσμίες', d: 'Κάθε συμβόλαιο, λογαριασμός και πιστοποιητικό σε ένα αρχείο, με ημερολόγιο που θυμάται τις λήξεις.', i: 'M4 4h6l2 2h8v12H4zM4 10h16' },
];
...
const FAQ = [
  ...
  { q: 'Ο βοηθός καταλαβαίνει και μιλάει ελληνικά;', a: 'Γράφει και καταλαβαίνει φυσικά ελληνικά, και σε Chrome ή Safari του μιλάς και σου διαβάζει τις απαντήσεις. Έχει μπροστά του τα δικά σου ακίνητα, δαπάνες και προθεσμίες· για νομικά και λογιστικά ζητήματα σε παραπέμπει στον κατάλληλο επαγγελματία.' },
  ...
  { q: 'Τι γίνεται όταν λήξει η δοκιμή;', a: 'Το πακέτο το διάλεξες ήδη στην εγγραφή, ανάλογα με τα ακίνητα και τις δυνατότητες που θέλεις, και είναι αυτό που συνεχίζει μετά τη δοκιμή. Τίποτα δεν αλλάζει χωρίς να το ξέρεις, και μπορείς να αναβαθμίσεις, να αλλάξεις ή να σταματήσεις όποτε θέλεις, σύμφωνα με την ισχύουσα τιμολογιακή πολιτική.' },
...
const AUDIENCE = [
  ...
  {
    tag: PLANS.solo.name,
    t: 'Ένα σπίτι που νοικιάζεις',
    d: 'Τι μπαίνει, τι βγαίνει και τι λήγει, χωρίς σημειώσεις.',
  },
  {
  ...
  },
  {
    ...
    t: 'Διαχειριστής ή μεσίτης',
    d: 'Λογοδοτείς σε τρίτους για κάθε ευρώ και προθεσμία.',
  },
  {
    tag: PLANS.office.name,
    t: 'Γραφείο με συνεργάτες',
    d: 'Πολλά ακίνητα και πολλά χέρια, ένα κοινό αρχείο.',
  },
];
...
const SECURITY = [
  { t: 'Κρυπτογραφημένη σύνδεση', d: 'Η επικοινωνία με το Property OS γίνεται πάντα μέσω TLS, σε κάθε συσκευή και δίκτυο.', i: 'M5 11h14v10H5zM8 11V7a4 4 0 0 1 8 0v4' },
  { t: 'Απομόνωση ανά χρήστη', d: 'Βλέπεις μόνο τα δικά σου δεδομένα. Πρόσβαση έχουν όσοι εσύ επιλέγεις.', i: 'M12 2l8 4v6c0 5-3.5 8-8 10-4.5-2-8-5-8-10V6z' },
  { t: 'Καμία εκπαίδευση μοντέλων', d: 'Δεν χρησιμοποιούμε ποτέ τα έγγραφα και τα δεδομένα σου για την εκπαίδευση μοντέλων.', i: 'M12 2v4M12 18v4M2 12h4M18 12h4M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8z' },
  ...
  return (
    <div className="lp-root" style={{ color: TEXT, minHeight: '100vh', fontFamily: T.font.sans, overflowX: 'clip', position: 'relative' }}>
      ...
      <style>{`
        ...
        /* Ο ΤΙΤΛΟΣ ΠΙΑΝΕΙ ΟΛΟ ΤΟ ΠΛΑΤΟΣ, ΤΟ ΚΕΙΜΕΝΟ ΣΠΑΕΙ ΣΕ ΔΥΟ ΣΤΗΛΕΣ.
           Με τον τίτλο κλεισμένο σε μισή στήλη έσπαγε σε τρεις σειρές και
           δίπλα του η εξήγηση ξεκινούσε από άλλο ύψος: δύο μπλοκ κειμένου που
           δεν στοιχίζονταν σε τίποτα. Μία γραμμή από πάνω, δύο στήλες από
           κάτω, και η ενότητα διαβάζεται με μία κίνηση. */
        .lp-why { display: grid; grid-template-columns: 1fr 1fr; gap: clamp(20px, 3vw, 44px); align-items: start; }
      ...
      {/* ── Security & trust ── */}
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP }}>
        {/* ΤΟ ΚΕΙΜΕΝΟ ΕΙΧΕ ΣΤΗΛΗ 220 ΕΙΚΟΝΟΣΤΟΙΧΕΙΩΝ ΚΑΙ ΓΙΝΟΤΑΝ ΚΟΡΔΕΛΑ. Οι
            τέσσερις εγγυήσεις μοιράζονταν το 1.1fr σε στήλες τόσο στενές που η
            τελευταία έβγαινε εννιά γραμμές: μια πρόταση των είκοσι λέξεων
        ...
        <div className="lp-split" style={{ background: PANEL, border: `1px solid ${LINE}`, borderRadius: 14, padding: 'clamp(24px, 3vw, 38px)', display: 'grid', gridTemplateColumns: 'minmax(0, 0.82fr) minmax(0, 1.18fr)', gap: 'clamp(24px, 3vw, 44px)', alignItems: 'start' }}>
          <div>
            ...
            <p style={{ fontSize: 15, color: MUTED, lineHeight: 1.6, margin: 0 }}>
              Λογαριασμοί, συμβόλαια και στοιχεία του ακινήτου σου ή των πελατών σου. Από τα πιο ευαίσθητα δεδομένα που υπάρχουν, και τα φυλάμε ανάλογα.
            </p>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '22px 26px' }}>
            {SECURITY.map((s, i) => (
            ...
            {/* Η ΑΠΟΚΑΛΥΨΗ ΓΙΑ ΤΟΥΣ ΠΑΡΟΧΟΥΣ ΕΚΤΟΣ ΕΕ ΔΕΝ ΧΑΝΕΤΑΙ, ΑΛΛΑΖΕΙ ΘΕΣΗ.
                Μέσα στο πλακίδιο των 218 εικονοστοιχείων γινόταν κορδέλα οκτώ
                γραμμών, τριπλάσια από τις άλλες τρεις εγγυήσεις δίπλα της. Είναι
                ψιλά γράμματα, και τα ψιλά γράμματα πάνε κάτω από τον πίνακα. */}
            <p style={{ gridColumn: '1 / -1', fontSize: 13, color: FAINT, lineHeight: 1.6, margin: 0 }}>
              Σχεδιασμένο σύμφωνα με τον Κανονισμό GDPR. Οι συμβάσεις με τους παρόχους εκτός ΕΕ ολοκληρώνονται πριν την κυκλοφορία· ποιοι είναι, το λέει η Πολιτική Απορρήτου.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="lp-reveal" style={{ ...wrap, position: 'relative', zIndex: 1, paddingBottom: GAP_ACT }}>
        ...
        {/* ═══ Η ΕΝΟΤΗΤΑ ΞΕΚΙΝΑΕΙ ΑΠΟ ΤΟΝ ΑΝΑΓΝΩΣΤΗ, ΟΧΙ ΑΠΟ ΕΜΑΣ ══════════
            Δύο γραφές πέρασαν από εδώ και οι δύο απέτυχαν με τον ίδιο τρόπο:
            μιλούσαν για το προϊόν σε άνθρωπο που δεν είχε ακόμη λόγο να τον
            νοιάζει. Η πρώτη έλεγε τι ΔΕΝ κάνουν το Excel και οι σημειώσεις —
            δηλαδή ότι ο αναγνώστης έκανε λάθος επιλογή. Η δεύτερη ξεκινούσε με
            «Ε2, Δήλωση Πληροφοριακών Στοιχείων Μίσθωσης, ΕΝΦΙΑ»: τρία αρκτικόλεξα
            πριν από μία ανθρώπινη πρόταση.

            Ο τίτλος τώρα λέει κάτι που ο αναγνώστης ξέρει ήδη για τον εαυτό του,
            και δεν το έχει ακούσει από εφαρμογή. Από εκεί και πέρα, το κείμενο
            έχει άδεια να μιλήσει: πρώτα η πραγματικότητά του, μετά η λύση.
            Καμία σύγκριση με τρίτους, καμία υπόσχεση που δεν κρατιέται. */}
        <div className="lp-eyebrow">Γιατί υπάρχει</div>
        <p style={{ fontSize: 'clamp(21px, 2.6vw, 30px)', lineHeight: 1.28, color: 'var(--text-primary)', margin: '0 0 clamp(22px, 2.6vw, 34px)', letterSpacing: '-0.025em', fontWeight: 450 }}>
          Κανείς δεν απέκτησε ακίνητο για να κάνει λογιστική.
        </p>
        <div className="lp-why">
          <div>
            <p style={{ fontSize: 15, lineHeight: 1.7, color: MUTED, margin: '0 0 18px' }}>
              Αν έχεις ακίνητα στην Ελλάδα, το ξέρεις καλύτερα από τον καθένα. Το φορολογικό πλαίσιο αλλάζει
              κάθε χρόνο, οι υποχρεώσεις πληθαίνουν και οι προθεσμίες δεν περιμένουν κανέναν. Ε2, Δήλωση
              Πληροφοριακών Στοιχείων Μίσθωσης, ΕΝΦΙΑ, τεκμαρτή έκπτωση, κοινόχρηστα, αποδείξεις: καθένα με
              τον δικό του κανόνα και τη δική του ημερομηνία.
            </p>
            <p style={{ fontSize: 15, lineHeight: 1.7, color: MUTED, margin: 0 }}>
              Το «ας είχα ένα σπιτάκι να το νοικιάζω» ήταν κάποτε απόφαση μιας ζωής. Σήμερα είναι μια δεύτερη
              δουλειά που δεν ζήτησε κανείς, και η ευθύνη γράφεται πάντα στο δικό σου όνομα.
            </p>
          </div>
          <div>
            <p style={{ fontSize: 15, lineHeight: 1.7, color: MUTED, margin: '0 0 18px' }}>
              Γι’ αυτό σχεδιάσαμε το Property OS. Οι ελληνικοί κανόνες είναι γραμμένοι μέσα του και
              ενημερώνονται σε ένα σημείο: ο υπολογισμός είναι έτοιμος πριν τον ζητήσεις, η προθεσμία μπαίνει
              στο ημερολόγιο πριν τη θυμηθείς, το παραστατικό καταχωρείται με μια φωτογραφία. Ο βοηθός
              τεχνητής νοημοσύνης απαντά με τα δικά σου νούμερα και την ισχύουσα νομοθεσία.
            </p>
            <p style={{ fontSize: 15, lineHeight: 1.7, color: MUTED, margin: '0 0 18px' }}>
              Ο λογιστής σου παίρνει φάκελο έτοιμο για δουλειά. Εσύ βλέπεις τι αποδίδει κάθε ακίνητο, πού
              πηγαίνει το κάθε ευρώ και τι αλλάζει η επόμενη κίνηση. Οι αποφάσεις μένουν δικές σου· τα
              υπόλοιπα τα κρατά η εφαρμογή.
            </p>
