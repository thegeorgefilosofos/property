...
export function ToolActions<S extends ToolSpec>(
  ...
  return (
    <>
      ...
      {/* ΤΟ ΤΥΠΩΜΕΝΟ ΧΑΡΤΙ ΞΕΡΕΙ ΑΠΟ ΠΟΥ ΗΡΘΕ. Χωρίς αυτή τη γραμμή, ο λογιστής
          που παίρνει τη σελίδα κρατά έναν αριθμό χωρίς προέλευση και χωρίς
          τρόπο να τον ξαναβγάλει με άλλα δεδομένα. Γράφεται η ΚΑΝΟΝΙΚΗ
          διεύθυνση και όχι το `window.location`: σε χαρτί, ένα «localhost:3000»
          ή μια διεύθυνση προεπισκόπησης δεν οδηγεί πουθενά. */}
      <p className="po-printonly" style={{ fontSize: 11, color: 'var(--text-tertiary)', margin: '10px 0 0' }}>
