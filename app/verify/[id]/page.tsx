      ...
      <div style={card}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 11, paddingBottom: 18, borderBottom: '1px solid #eef0f2' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: '#6b7280' }}>Επαλήθευση γνησιότητας εγγράφου</div>
          </div>
        </div>

        {state === 'loading' && (
          <div style={{ padding: '34px 0', textAlign: 'center', color: '#8a8f98', fontSize: 13 }}>Έλεγχος εγγράφου…</div>
        )}
        ...
        {state === 'notfound' && (
          <div style={{ paddingTop: 24 }}>
            ...
            <p style={{ fontSize: 13, color: '#6b7280', lineHeight: 1.6, marginTop: 8 }}>
              Ο κωδικός <strong style={{ color: '#111' }}>{id || '—'}</strong> δεν αντιστοιχεί σε έγγραφο που εκδόθηκε από το Property OS.
        ...
        {state === 'ok' && doc && (
          <div style={{ paddingTop: 22 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: 10, padding: '11px 14px' }}>
              <span style={{ color: '#15803d', fontSize: 18, fontWeight: 700 }}>✓</span>
              <span style={{ fontSize: 13.5, fontWeight: 600, color: '#166534' }}>Γνήσιο έγγραφο, εκδόθηκε από το Property OS</span>
            </div>
            ...
            <p style={{ fontSize: 10.5, color: '#9aa0a6', lineHeight: 1.6, marginTop: 24, paddingTop: 14, borderTop: '1px solid #eef0f2' }}>
