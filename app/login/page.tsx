...
const PILLARS = [
  { label: 'Πλήρης οικονομική εικόνα', text: 'Έσοδα, δαπάνες και απόδοση κάθε ακινήτου σε πραγματικό χρόνο — μεικτή και καθαρή, μετά από φόρους και λειτουργικά.' },
  { label: 'Σύγκριση παρόχων ενέργειας', text: '11 πάροχοι ρεύματος και αερίου. Βρες αυτόματα το φθηνότερο τιμολόγιο για την κατανάλωσή σου.' },
  { label: 'Φορολογία 2026', text: 'Υπολογισμός φόρου εισοδήματος με την ισχύουσα κλίμακα και εξαγωγή έτοιμη για τον λογιστή σου.' },
  { label: 'Χαρτοφυλάκιο έως 15 ακίνητα', text: 'Κατοικία, επαγγελματικός χώρος, αποθήκη, οικόπεδο — κάθε τύπος, ενιαία διαχείριση.' },
      ...
      <div className="auth-aside" style={{ width: '46%', minWidth: 400, background: 'var(--bg-elevated)', borderRight: '1px solid var(--border-subtle)', display: 'flex', flexDirection: 'column', padding: '44px 52px', overflowY: 'auto' }}>
        ...
        <div style={{ marginBottom: 44 }}>
          ...
          <p style={{ fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.7, margin: 0, maxWidth: 380 }}>
            Η πληρέστερη πλατφόρμα διαχείρισης ακινήτων για Έλληνες ιδιοκτήτες και μικρά γραφεία — αποδόσεις, δαπάνες, ενέργεια, φορολογία και ενοικιαστές, σε παγκόσμιο επίπεδο.
          </p>
        </div>
