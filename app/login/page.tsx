...
const PILLARS = [
  { label: 'Μία φωτογραφία, όλα καταχωρημένα', text: 'Σκάναρε λογαριασμό, συμβόλαιο ή ασφάλεια. Το AI τα διαβάζει και τα βάζει μόνα τους στη σωστή θέση.' },
  { label: 'Βοηθός που ξέρει το ακίνητό σου', text: 'Ρώτα στα ελληνικά, με κείμενο ή με τη φωνή σου. Απαντά με τα δικά σου νούμερα και σε καθοδηγεί.' },
  { label: 'Πλήρης οικονομική εικόνα', text: 'Έσοδα, δαπάνες και απόδοση κάθε ακινήτου σε πραγματικό χρόνο, μεικτή και καθαρή, μετά από φόρους και έξοδα.' },
  { label: 'Το φθηνότερο ρεύμα, αυτόματα', text: 'Συγκρίνει τα τιμολόγια της αγοράς με βάση την κατανάλωσή σου και σου δείχνει πόσα γλιτώνεις.' },
