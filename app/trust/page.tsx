    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p className="lg-note">
            Βρήκες κενό ασφαλείας; Γράψε μας πριν το δημοσιοποιήσεις και θα το διορθώσουμε γρήγορα, με αναφορά σε
            εσένα αν το θέλεις. Δεσμευόμαστε να μη στραφούμε νομικά εναντίον ερευνητή που ενεργεί καλόπιστα και δεν
            αποκτά πρόσβαση σε δεδομένα τρίτων· οι πλήρεις όροι είναι δημοσιευμένοι
            στο <a href="/.well-known/security.txt" style={{ color: 'var(--accent)', textDecoration: 'none' }}>/.well-known/security.txt</a>.
          </p>
        </>
      ),
    },
