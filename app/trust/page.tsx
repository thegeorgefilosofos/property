    ...
    <div style={{ background: 'var(--bg-base)', color: 'var(--text-primary)', minHeight: '100vh', fontFamily: T.font.sans }}>
      ...
      <main style={{ maxWidth: 780, margin: '0 auto', padding: 'clamp(32px,6vw,64px) clamp(20px,5vw,40px)' }}>
        ...
        <section style={SECTION}>
          ...
          {!published && (
            <p style={{ ...P, padding: '12px 14px', background: 'var(--warning-soft)', border: '1px solid var(--warning-border)', borderRadius: 10, margin: '0 0 14px' }}>
              ...
              ισχύουν όμως ήδη (ένα ακίνητο χωρίς συνδρομή, μετά τις ημέρες της δοκιμής). Τα πλήρη νομικά στοιχεία
        ...
        <section style={SECTION}>
          ...
          <p style={P}>
            Το σύστημα καταγραφής (η βάση δεδομένων, οι κωδικοί σύνδεσης και τα αρχεία που
            ανεβάζεις) βρίσκεται σε διακομιστές <strong style={{ color: 'var(--text-primary)' }}>εντός Ευρωπαϊκής
        ...
        <section style={SECTION}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 13, marginTop: 6 }}>
            ...
            <Never><strong style={{ color: 'var(--text-primary)' }}>Δεν σε κλειδώνουμε μέσα.</strong> Κατεβάζεις με ένα κουμπί όλες τις καταχωρήσεις σου σε ένα αρχείο JSON (τα ανεβασμένα αρχεία τα κατεβάζεις χωριστά από τα Χαρτιά και οι επαφές μαζί τους), και διαγράφεις τον λογαριασμό σου χωρίς να χρειαστεί να μας γράψεις.</Never>
          </div>
        </section>
