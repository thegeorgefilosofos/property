    ...
    <div style={{ background: 'var(--bg-base)', color: 'var(--text-primary)', minHeight: '100vh', fontFamily: T.font.sans }}>
      ...
      <main style={{ maxWidth: 780, margin: '0 auto', padding: 'clamp(32px,6vw,64px) clamp(20px,5vw,40px)' }}>
        ...
        <section style={SECTION}>
          ...
          <p style={P}>
            Δύο πράγματα φεύγουν από την ΕΕ και το λέμε καθαρά, αντί να το κρύψουμε σε υποσημείωση:
            το <strong style={{ color: 'var(--text-primary)' }}>κρυπτογραφημένο αντίγραφο ασφαλείας</strong>,
            που φυλάσσεται σε υποδομή των ΗΠΑ και ανοίγει μόνο με κλειδί που δεν το έχει ο πάροχος, και
            τα <strong style={{ color: 'var(--text-primary)' }}>ερωτήματά σου προς τον βοηθό</strong>,
            μαζί με τα συμφραζόμενα που χρειάζεται για να απαντήσει. Ο πλήρης κατάλογος με τις τοποθεσίες
            είναι πιο κάτω σε αυτή τη σελίδα.
          </p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14, marginTop: 16 }}>
            ...
            <Point title="Καθημερινό αντίγραφο ασφαλείας">
              ...
              χωρίς το κλειδί δεν ανοίγει από κανέναν. Είναι σχεδιασμένη ώστε να <strong style={{ color: 'var(--text-primary)' }}>αποτυγχάνει
              αντί να ανεβάσει μη κρυπτογραφημένο αρχείο</strong>: κρυπτογραφημένο αντίγραφο ή κανένα.
            </Point>
