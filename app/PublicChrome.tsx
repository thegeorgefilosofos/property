    ...
    <footer style={{ borderTop: '1px solid var(--border-subtle)' }}>
      <div style={{ ...WRAP, padding: `clamp(36px,5vw,56px) ${WRAP_PAD} clamp(24px,3vw,32px)` }}>
        <div className="lp-foot">
          ...
          <FootCol label="Εργαλεία" links={[['/vraxyxronia-i-makroxronia', 'Βραχυχρόνια ή μακροχρόνια'], ['/ypologismos-enfia', 'ΕΝΦΙΑ'], ['/ypologismos-forou-enoikion', 'Φορολογία ενοικίων']]} />
