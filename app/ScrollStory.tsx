...
const ACTS = [
  {
    ...
    p: 'Λογαριασμός, μισθωτήριο ή ασφαλιστήριο: φωτογραφίζεις και ο βοηθός αναγνωρίζει ποσό, πάροχο, προθεσμία και τα καταχωρεί μόνος του στο σωστό ακίνητο.',
  ...
  },
  {
    ...
    p: 'Ρωτάς όπως θα ρωτούσες έναν σύμβουλο, κι εκείνος απαντά με βάση τα δικά σου δεδομένα: σου δείχνει την επόμενη κίνηση ή σε παραπέμπει στον κατάλληλο επαγγελματία.',
  ...
  },
  {
    ...
    p: 'Όσα κατέγραψες γίνονται εικόνα: απόδοση, δαπάνες και συγκρίσεις παρόχων, ζωντανά. Κι όταν υπάρχει τρόπος να γλιτώσεις χρήματα, το βλέπεις πρώτος από όλους.',
