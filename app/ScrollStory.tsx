...
const ACTS = [
  {
    ...
    p: 'Λογαριασμός, μισθωτήριο ή ασφαλιστήριο, σε φωτογραφία ή PDF: ο βοηθός συμπληρώνει ό,τι θα πληκτρολογούσες εσύ.',
  ...
  },
  {
    ...
    p: 'Ρωτάς όπως θα ρωτούσες έναν σύμβουλο, στα ελληνικά, και η απάντηση βγαίνει από τα δικά σου δεδομένα, όχι από εγχειρίδια.',
  ...
  },
  {
    ...
    p: 'Όσα κατέγραψες γίνονται εικόνα την ίδια στιγμή, χωρίς να ετοιμάσεις τίποτα και χωρίς να περιμένεις το τέλος του μήνα.',
