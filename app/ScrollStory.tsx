...
const ACTS = [
  {
    ...
    p: 'Λογαριασμός ρεύματος, κοινόχρηστα, μισθωτήριο, ασφαλιστήριο. Το φωτογραφίζεις και ο βοηθός διαβάζει ποσό, πάροχο, προθεσμία, κατανάλωση, και τα καταχωρεί στο σωστό ακίνητο.',
  ...
  },
  {
    ...
    p: 'Ρωτάς τον βοηθό όπως έναν σύμβουλο, κι εκείνος σε κατευθύνει με βάση τα δεδομένα και τις ανάγκες σου. Προτείνει τη βέλτιστη επιλογή ή τον κατάλληλο επαγγελματία.',
  ...
  },
  {
    ...
    p: 'Όσα κατέγραψες γίνονται εικόνα: απόδοση, δαπάνες και συγκρίσεις παρόχων σε πραγματικό χρόνο. Όταν υπάρχει τρόπος να γλιτώσεις χρήματα, το βλέπεις πρώτος.',
