...
const ACTS = [
  {
    ...
    p: 'Λογαριασμός, μισθωτήριο ή ασφαλιστήριο: φωτογραφίζεις και ο βοηθός αναγνωρίζει ποσό, πάροχο, προθεσμία και τα καταχωρεί στο σωστό ακίνητο.',
  ...
  },
  {
    ...
    p: 'Ρωτάς όπως θα ρωτούσες έναν σύμβουλο, κι εκείνος απαντά με βάση τα δικά σου δεδομένα: σου δείχνει την επόμενη κίνηση ή σε παραπέμπει σε επαγγελματία.',
