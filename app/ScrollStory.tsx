...
const ACTS = [
  ...
  },
  {
    ...
    b: ['Απαντά με τα δικά σου στοιχεία, όχι με γενικότητες', 'Καταλαβαίνει ΔΕΗ, ΕΝΦΙΑ, κοινόχρηστα και τιμολόγια', 'Σε πάει κατευθείαν στη σωστή οθόνη για να πράξεις'],
