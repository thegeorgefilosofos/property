...
export default function GuestCheckin() {
  ...
  const field: React.CSSProperties = { width: '100%', boxSizing: 'border-box', background: 'var(--bg-surface)', border: '1px solid var(--border-default)', borderRadius: 4, padding: '10px 16px', height: 40, color: 'var(--text-primary)', fontSize: 14, outline: 'none', fontFamily: 'inherit' };
