  ...
  return (
    <div style={{ fontFamily: T.font.sans }}>
      ...
      <ToolCta
        ...
        body="Το Property OS καταγράφει κρατήσεις, ενοίκια και δαπάνες στο ίδιο σημείο, υπολογίζει το τέλος ανθεκτικότητας ανά διανυκτέρευση και προετοιμάζει τη δήλωση με τα πραγματικά σου δεδομένα."
      />
    </div>
  );
}
