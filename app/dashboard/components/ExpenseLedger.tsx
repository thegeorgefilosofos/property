  ...
  return (
    <div>
      ...
      {/* ── ΜΙΑ ΕΝΕΡΓΕΙΑ, ΣΤΗΝ ΚΟΡΥΦΗ ────────────────────────────────────────
          ...
          · Η «Φωτογραφία» ήταν το ΙΔΙΟ πράγμα με το «Φωτογράφισε έγγραφο» της
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          action={onScan ? <Btn variant="primary" onClick={onScan}>Φωτογράφισε λογαριασμό</Btn> : <Btn variant="primary" onClick={() => setAdding(true)}>Νέα δαπάνη</Btn>}
        />
