...
export const s = {
  ...
  kpi:      { background:'var(--bg-elevated)', border:'1px solid var(--border-subtle)', borderRadius:T.radius.card, padding:'14px 16px', textAlign:'center' as const } as React.CSSProperties,
