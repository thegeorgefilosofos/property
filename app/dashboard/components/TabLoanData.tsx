...
export const BANKS = [
  { id:'eurobank', name:'Eurobank', color:'#1565C0', fixed3:'2.50-2.90', fixed5:'3.40-3.50', fixed10:'3.80-3.90', fixed15:'4.10-4.20', fixed20:'4.10-4.20', variable_spread_min:0.60, variable_spread_max:2.45, fixed_min:2.50, max_ltv:90, max_years:35, max_amount:500000, max_age:75, min_amount:20000, green_discount:0.20, spiti_mou:true, features:['Spread 0.60% (χαμηλότερο αγοράς)','Χωρίς έξοδα έγκρισης','Νομικός+Τεχνικός δωρεάν','Προέγκριση 48ω','gov.gr υπογραφή','Εκταμίευση 10 εργ. ημ.'], programs:['Σπίτι μου ΙΙ','Αναβαθμίζω','Εξοικονομώ'], fees:'Χωρίς έξοδα εξέτασης', note:'Χαμηλότερο spread αγοράς', url:'https://www.eurobank.gr/el/retail/proionta-upiresies/proionta/daneia/stegastika' },
...
export const STATE_PROGRAMS = [
  ...
  { id:'anakainizo_noikazo', name:'Ανακαινίζω & Νοικιάζω', color:'#fb923c', status:'active', type:'Επιδότηση ανακαίνισης + εγγυημένο ενοίκιο ΟΠΕΚΑ', desc:'40% επιδότηση + εγγυημένο ενοίκιο 5 χρόνια', max_amount:15000, max_prop_value:null, max_ltv:null, max_sqm:null, age_min:18, age_max:null, duration:'5 χρόνια', deadline:'Τρέχον', deadline_urgent:false, total_budget:'Τρέχον', criteria:['Κενό ακίνητο ≥3 χρόνια','€5.000-€40.000','Μίσθωση ΟΠΕΚΑ','Δέσμευση 5ετίας'], how_it_works:'40% επιδότηση ανακαίνισης + ενοίκιο αγοράς από ΟΠΕΚΑ για 5 χρόνια', extra:'Εγγυημένο εισόδημα — ιδανικό για επενδυτές', savings_example:'Κενό ακίνητο → ανακαίνιση + εγγυημένο εισόδημα', url:'https://www.opeka.gr', banks:['Εθνική','Πειραιώς','Eurobank'] },
