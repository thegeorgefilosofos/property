...
export const GLOSSARY = [
  ...
  {term:'DTI / DSTI Ratio',  def:'Δόση προς εισόδημα. Θεσμικά όρια ΤτΕ (από 1/1/2025): ≤50% για πρώτη κατοικία/πρώτη φορά, ≤40% για τους υπόλοιπους. Οι τράπεζες συχνά πιο συντηρητικές.'},
