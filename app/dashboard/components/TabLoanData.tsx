...
export const STATE_PROGRAMS = [
  ...
  { id:'anakainizo_noikazo', name:'Ανακαινίζω και Νοικιάζω', status:'active', type:'Επιδότηση ανακαίνισης + εγγυημένο ενοίκιο ΟΠΕΚΑ', desc:'40% επιδότηση + εγγυημένο ενοίκιο 5 χρόνια', max_amount:15000, max_prop_value:null, max_ltv:null, max_sqm:null, age_min:18, age_max:null, duration:'5 χρόνια', deadline:'Τρέχον',  total_budget:'Τρέχον', criteria:['Κενό ακίνητο ≥3 χρόνια','€5.000–€40.000','Μίσθωση ΟΠΕΚΑ','Δέσμευση 5ετίας'], how_it_works:'40% επιδότηση ανακαίνισης + ενοίκιο αγοράς από ΟΠΕΚΑ για 5 χρόνια', extra:'Εγγυημένο εισόδημα, ιδανικό για επενδυτές', savings_example:'Κενό ακίνητο → ανακαίνιση + εγγυημένο εισόδημα', url:'https://www.opeka.gr', banks:['Εθνική','Πειραιώς','Eurobank'] },
  { id:'gefyra_3', name:'Γέφυρα 3', status:'active', type:'Επιδότηση δόσης, ευάλωτοι δανειολήπτες', desc:'Επιδότηση 50% αύξησης δόσης λόγω ανόδου Euribor', max_amount:null, max_prop_value:null, max_ltv:null, max_sqm:null, age_min:18, age_max:null, duration:'12 μήνες', deadline:'Τρέχον, έλεγξε dovaluegreece.gr',  total_budget:'Χρηματοδοτείται από τράπεζες', criteria:['Βεβαίωση ευάλωτου οφειλέτη','Κυμαινόμενο δάνειο','Εξασφάλιση πρώτης κατοικίας'], how_it_works:'50% αύξησης δόσης λόγω ΕΚΤ (βάση 30/06/2022) για 12 μήνες', extra:'Για ανέργους, χαμηλά εισοδήματα, συνταξιούχους', savings_example:'Αύξηση 80€/μήνα → επιδότηση 40€ × 12 = 480€/χρόνο', url:'https://dovaluegreece.gr/programma-epidotisis-dosis-logo-ayxisis-epitokion-gefyra-3', banks:['Όλες οι τράπεζες'] },
]
...
export const LOAN_TYPES: Record<LoanType,{label:string;desc:string;typical_rate:string;typical_ltv:number;notes:string;docs:LoanDoc[];tax_note:string}> = {
  purchase:     {label:'Αγορά κατοικίας',       desc:'Αγορά παλαιάς ή νέας κατοικίας',        typical_rate:'2,60–3,80%', typical_ltv:80, notes:'Πιο διαδεδομένος τύπος', docs:[
  ...
  ], tax_note:'Φόρος μεταβίβασης 3%, με απαλλαγή πρώτης κατοικίας εφόσον πληρούνται οι όροι'},
  first_home:   {label:'Πρώτη κατοικία',        desc:'Σπίτι μου ΙΙ, πολύ χαμηλό επιτόκιο',  typical_rate:'1,00–2,00%', typical_ltv:90, notes:'Ηλικία 25–50, προθεσμία 31/08/2026', docs:[
    {name:'Δελτίο ταυτότητας ή διαβατήριο'},
  ...
  renovation:   {label:'Ανακαίνιση',            desc:'Χρηματοδότηση ανακαίνισης',             typical_rate:'3,00–4,50%', typical_ltv:70, notes:'Χωρίς εγγύηση σε μικρά ποσά', docs:[
    {name:'Δελτίο ταυτότητας ή διαβατήριο'},
  ...
  energy:       {label:'Ενεργειακή αναβάθμιση', desc:'Πράσινα δάνεια, περιθώριο από 1,25%',   typical_rate:'2,40–3,50%', typical_ltv:80, notes:'Έκπτωση -0,10 έως -0,25% για κλάση Α ή Α+', docs:[
  ...
  investment:   {label:'Επενδυτικό ακίνητο',    desc:'Αγορά για εκμετάλλευση ή ενοικίαση',   typical_rate:'3,00–4,50%', typical_ltv:70, notes:'Το εισόδημα ενοικίου προσμετράται', docs:[
    {name:'Δελτίο ταυτότητας ή διαβατήριο'},
  ...
  ], tax_note:'Φόρος μεταβίβασης 3%, έλεγξε βάρη και δεσμεύσεις του ακινήτου (Κτηματολόγιο)'},
  construction: {label:'Ανέγερση κατοικίας',    desc:'Χρηματοδότηση κατασκευής',             typical_rate:'3,00–4,50%', typical_ltv:75, notes:'Εκταμίευση σε φάσεις', docs:[
  ...
  commercial:   {label:'Επαγγελματικό ακίνητο', desc:'Γραφεία, καταστήματα, αποθήκες',       typical_rate:'3,50–5,00%', typical_ltv:65, notes:'Οι τόκοι εκπίπτουν φορολογικά', docs:[
  ...
  land:         {label:'Αγορά οικοπέδου',        desc:'Αγορά οικοπέδου ή αγροτεμαχίου',      typical_rate:'3,50–5,00%', typical_ltv:60, notes:'Χαμηλότερο δάνειο προς αξία', docs:[
    {name:'Δελτίο ταυτότητας ή διαβατήριο'},
    {name:'Φορολογικά στοιχεία εισοδήματος', where:'ΑΑΔΕ'},
    {name:'Τοπογραφικό διάγραμμα', where:'Μηχανικός'},
    {name:'Βεβαίωση αρτιότητας και οικοδομησιμότητας', where:'Πολεοδομία'},
  ], tax_note:'Φόρος μεταβίβασης 3%, έλεγξε τη χρήση γης και τις εκτός σχεδίου διατάξεις'},
  refinance:    {label:'Αναχρηματοδότηση',       desc:'Μεταφορά δανείου σε άλλη τράπεζα',     typical_rate:'2,60–3,80%', typical_ltv:80, notes:'Εξοικονόμηση από χαμηλότερο επιτόκιο', docs:[
    {name:'Δελτίο ταυτότητας ή διαβατήριο'},
    {name:'Φορολογικά στοιχεία εισοδήματος', where:'ΑΑΔΕ'},
