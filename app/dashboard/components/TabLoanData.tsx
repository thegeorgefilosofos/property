...
export const LOAN_TYPES: Record<LoanType,{label:string;desc:string;rate_from:number;rate_to:number;typical_ltv:number;notes:string;docs:LoanDoc[];tax_note:string}> = {
  purchase:     {label:'Αγορά κατοικίας',       desc:'Αγορά παλαιάς ή νέας κατοικίας',        rate_from:2.60, rate_to:3.80, typical_ltv:80, notes:'Πιο διαδεδομένος τύπος', docs:[
  ...
  first_home:   {label:'Πρώτη κατοικία',        desc:'Σπίτι μου ΙΙ, πολύ χαμηλό επιτόκιο',  rate_from:1.00, rate_to:2.00, typical_ltv:90, notes:'Ηλικία 25–50, προθεσμία 31/08/2026', docs:[
    {name:'Δελτίο ταυτότητας ή διαβατήριο'},
  ...
  energy:       {label:'Ενεργειακή αναβάθμιση', desc:'Πράσινα δάνεια, περιθώριο από 1,25%',   rate_from:2.40, rate_to:3.50, typical_ltv:80, notes:'Έκπτωση -0,10 έως -0,25% για κλάση Α ή Α+', docs:[
  ...
  refinance:    {label:'Αναχρηματοδότηση',       desc:'Μεταφορά δανείου σε άλλη τράπεζα',     rate_from:2.60, rate_to:3.80, typical_ltv:80, notes:'Εξοικονόμηση από χαμηλότερο επιτόκιο', docs:[
    {name:'Δελτίο ταυτότητας ή διαβατήριο'},
    {name:'Φορολογικά στοιχεία εισοδήματος', where:'ΑΑΔΕ'},
