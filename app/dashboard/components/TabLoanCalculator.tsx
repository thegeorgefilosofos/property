...
const AREA_OPTIONS = [
  // ── Αττική ──────────────────────────────────────────────────────────────────
  { value:'attica_center_prime',   label:'Αθήνα Κέντρο Α',        description:'Κολωνάκι, Σύνταγμα, Εξάρχεια, Πλάκα, Μεταξουργείο' },
  { value:'attica_center_std',     label:'Αθήνα Κέντρο Β',        description:'Κυψέλη, Ζωγράφου, Παγκράτι, Νέος Κόσμος, Νέα Σμύρνη' },
  { value:'attica_south_prime',    label:'Αττική Νότια Α',         description:'Γλυφάδα, Βούλα, Βουλιαγμένη, Βάρη, Άνω Βούλα' },
  { value:'attica_south_std',      label:'Αττική Νότια Β',         description:'Άλιμος, Ελληνικό, Αργυρούπολη, Καλλιθέα, Άγιος Δημήτριος' },
  { value:'attica_north_prime',    label:'Αττική Βόρεια Α',        description:'Κηφισιά, Εκάλη, Διόνυσος, Νέα Ερυθραία, Νέα Πεντέλη' },
  { value:'attica_north_std',      label:'Αττική Βόρεια Β',        description:'Μαρούσι, Χαλάνδρι, Αγία Παρασκευή, Βριλήσσια, Φιλοθέη' },
  ...
  { value:'attica_piraeus_prime',  label:'Πειραιάς Α',             description:'Καστέλα, Φρεαττύδα, Πασαλιμάνι' },
  { value:'attica_piraeus_std',    label:'Πειραιάς Β',             description:'Κερατσίνι, Νίκαια, Δραπετσώνα, Κορυδαλλός' },
  { value:'attica_riviera',        label:'Αττική Ριβιέρα',         description:'Σαρωνίδα, Λαγονήσι, Σούνιο, Ανάβυσσος, Λαύριο' },
  { value:'attica_suburbs_mid',    label:'Αττική Μεσαία Προάστια', description:'Νέα Ιωνία, Ηράκλειο, Λυκόβρυση, Μεταμόρφωση, Γαλάτσι' },
  // ── Θεσσαλονίκη ─────────────────────────────────────────────────────────────
  { value:'thess_center',          label:'Θεσσαλονίκη Κέντρο',    description:'Κέντρο, ΑΠΘ, Λαδάδικα, Βαρδάρης, Ιπποκράτειο' },
  { value:'thess_east',            label:'Θεσσαλονίκη Ανατολικά', description:'Καλαμαριά, Τριανδρία, Χαριλάου' },
  { value:'thess_suburbs_n',       label:'Θεσσαλονίκη Βόρεια',    description:'Πυλαία, Χορτιάτης, Θέρμη, Ταγαράδες' },
  { value:'thess_suburbs_w',       label:'Θεσσαλονίκη Δυτικά',    description:'Σταυρούπολη, Ευόσμος, Κορδελιό, Αμπελόκηποι' },
  { value:'thess_halkidiki',       label:'Χαλκιδική',              description:'Κασσάνδρα, Σιθωνία, Άθως' },
  // ── Κρήτη ────────────────────────────────────────────────────────────────────
  { value:'crete_heraklion',       label:'Ηράκλειο Κρήτης',       description:'Ηράκλειο, Γάζι, Αρχάνες, Ν. Αλικαρνασσός' },
  { value:'crete_chania',          label:'Χανιά',                  description:'Χανιά, Ακρωτήρι, Πλατανιάς, Κολυμβάρι' },
  { value:'crete_rethymno',        label:'Ρέθυμνο',                description:'Ρέθυμνο, Σπήλι, Αρκάδι' },
  { value:'crete_lasithi',         label:'Λασίθι',                 description:'Άγιος Νικόλαος, Ιεράπετρα, Σητεία' },
  { value:'crete_elounda',         label:'Ελούντα',                description:'Ελούντα, Πλάκα, Σπιναλόγκα' },
  // ── Νησιά ─────────────────────────────────────────────────────────────────────
  ...
  { value:'mykonos',               label:'Μύκονος',                description:'Μύκονος, Άνω Μέρα, Ορνός' },
  { value:'santorini',             label:'Σαντορίνη',              description:'Φηρά, Οία, Ημεροβίγλι, Ακρωτήρι' },
  { value:'paros_naxos',           label:'Πάρος / Νάξος',          description:'Παροικία, Νάουσα, Νάξος πόλη' },
  { value:'syros',                 label:'Σύρος',                  description:'Ερμούπολη, Άνω Σύρος, Μέγας Γιαλός' },
  { value:'corfu',                 label:'Κέρκυρα',                description:'Κέρκυρα πόλη, Κανόνι, Βόρεια Κέρκυρα' },
  { value:'lefkada_zakynthos',     label:'Ιόνια Νησιά',            description:'Λευκάδα, Ζάκυνθος, Κεφαλλονιά, Ιθάκη' },
  { value:'lesvos',                label:'Βόρειο Αιγαίο',          description:'Λέσβος, Χίος, Σάμος' },
  { value:'sporades',              label:'Βόρειες Σποράδες',       description:'Σκιάθος, Σκόπελος, Αλόννησος, Σκύρος' },
  // ── Πελοπόννησος ─────────────────────────────────────────────────────────────
  { value:'patras',                label:'Αχαΐα',                  description:'Πάτρα, Ρίο, Αίγιο, Καλάβρυτα' },
  { value:'peloponnese_coast',     label:'Αργολίδα Νότια',         description:'Ναύπλιο, Πόρτο Χέλι, Λεωνίδιο, Τολό' },
  { value:'kalamata',              label:'Μεσσηνία',               description:'Καλαμάτα, Πύλος, Μεθώνη, Κορώνη' },
  { value:'sparta_lakonia',        label:'Λακωνία',                description:'Σπάρτη, Μονεμβάσια, Γύθειο, Μάνη' },
  { value:'corinthia',             label:'Κορινθία',               description:'Κόρινθος, Λουτράκι, Νεμέα' },
  { value:'tripoli',               label:'Αρκαδία',                description:'Τρίπολη, Άστρος, Ελάτη' },
  // ── Κεντρική Ελλάδα ──────────────────────────────────────────────────────────
  { value:'larissa',               label:'Λάρισα',                 description:'Λάρισα, Τύρναβος, Ελασσόνα' },
  { value:'volos',                 label:'Μαγνησία',               description:'Βόλος, Πήλιο, Αλόννησος, Σκιάθος' },
  { value:'ioannina',              label:'Ιωάννινα',               description:'Ιωάννινα, Πρέβεζα, Άρτα, Ζαγόρι' },
  { value:'agrinio',               label:'Αιτωλοακαρνανία',        description:'Αγρίνιο, Μεσολόγγι, Ναύπακτος' },
  { value:'lamia',                 label:'Φθιώτιδα',               description:'Λαμία, Αμφίκλεια, Καρπενήσι' },
  { value:'evia',                  label:'Εύβοια',                 description:'Χαλκίδα, Ερέτρια, Κάρυστος, Λίμνη' },
  // ── Βόρεια Ελλάδα ────────────────────────────────────────────────────────────
  { value:'kavala',                label:'Καβάλα',                 description:'Καβάλα, Θάσος, Χρυσούπολη' },
  { value:'drama_xanthi',          label:'Δράμα / Ξάνθη',          description:'Δράμα, Ξάνθη, Κομοτηνή' },
  { value:'alexandroupoli',        label:'Αλεξανδρούπολη',         description:'Αλεξανδρούπολη, Ορεστιάδα, Σαμοθράκη' },
  { value:'serres_kilkis',         label:'Σέρρες / Κιλκίς',        description:'Σέρρες, Κιλκίς, Σιδηρόκαστρο' },
  { value:'imathia_pella',         label:'Ημαθία / Πέλλα',         description:'Βέροια, Νάουσα, Έδεσσα, Αλεξάνδρεια' },
  { value:'katerini_pieria',       label:'Πιερία',                 description:'Κατερίνη, Παραλία, Πλαταμώνας' },
  { value:'kozani_florina',        label:'Δυτική Μακεδονία',       description:'Κοζάνη, Φλώρινα, Καστοριά, Γρεβενά' },
  { value:'thassos',               label:'Θάσος',                  description:'Θάσος, Λιμένας, Σκάλα Πρίνου' },
]
