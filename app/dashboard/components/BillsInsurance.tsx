...
const INSURANCE_COMPANIES = [
  ...
  { value: 'cosmote_ins',   label: 'COSMOTE Insurance',         url: 'https://www.cosmoteinsurance.gr/home', agent_label: 'Online — COSMOTE',
    propertyTypes: ['Κύρια Κατοικία','Εξοχική Κατοικία'],
    note: 'Από 96€/έτος (8€/μήνα) για διαμέρισμα 80τ.μ. 2020. 10% έκπτωση για συνδρομητές COSMOTE.',
    plans: [
      { id: 'ci_basic',   name: 'Smart Home Βασικό',         monthly: 8.00,  annual: 96,  covers: ['Πυρκαγιά','Θραύση Σωληνώσεων','Φυσικά Φαινόμενα','Βραχυκύκλωμα','Αστική Ευθύνη'], earthquake: false, flood: false, natural: false },
      { id: 'ci_plus',    name: 'Smart Home Πλήρες',         monthly: 14.50, annual: 139, covers: ['Πυρκαγιά','Κλοπή','Πλημμύρα','Φυσικά Φαινόμενα','Αστική Ευθύνη'], earthquake: false, flood: true,  natural: true  },
      { id: 'ci_total',   name: 'Smart Home Ολοκληρωμένο',  monthly: 21.00, annual: 199, covers: ['Πλήρης Κάλυψη + Σεισμός + Κατολίσθηση + Νομική Προστασία'], earthquake: true,  flood: true,  natural: true  },
    ] },
