  ...
  return (
    <div style={{ fontFamily: T.font.sans, color: 'var(--text-primary)' }}>
      ...
      <div style={card}>
        ...
        <div style={{ fontSize: 10, fontWeight: 600, color: 'var(--text-secondary)', textTransform: 'uppercase' as const, letterSpacing: '0.06em', marginBottom: 10, fontFamily: T.font.sans }}>Σύγκριση Ασφαλιστικών — Ενδεικτικές τιμές</div>
