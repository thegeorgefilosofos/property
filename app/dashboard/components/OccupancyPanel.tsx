            ...
            <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 148px), 1fr))', gap: 10, marginBottom: 14 }}>
                ...
                {kpi('Μένει καθαρά', fe(stNet), 'var(--text-primary)',
                  `Ακαθάριστα − φόρος − τέλος ανθεκτικότητας − τέλος παρεπιδημούντων − προμήθειες πλατφορμών. Η προμήθεια δεν μειώνει το δηλωτέο έσοδο, φεύγει όμως από την τσέπη σου.${tot.platformFees > 0 ? '' : ' Δεν υπάρχει καταγεγραμμένη προμήθεια σε αυτές τις κρατήσεις — αν υπήρξε, το πραγματικό υπόλοιπο είναι μικρότερο.'}`)}
