        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 11, color: '#5a5a70' }}>AI ανάλυση βάσει των δεδομένων του ακινήτου</p>
            </div>
          </div>
                ...
                <div key={idx} style={{
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 3, flexWrap: 'wrap' }}>
                      ...
                      <span style={{ fontSize: 9, fontFamily: 'JetBrains Mono, monospace', padding: '1px 6px', borderRadius: 4, color, background: `${color}18`, border: `1px solid ${color}33` }}>{label}</span>
                      {s.recurring && (
                  ...
                  <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
                    ...
                    <button onClick={() => dismiss(idx)} style={{ padding: '5px 7px', background: 'transparent', border: '1px solid #1e1e30', borderRadius: 6, cursor: 'pointer', color: '#3a3a54', display: 'flex' }}>
                      <X size={11}/>
                    </button>
                  </div>
                </div>
