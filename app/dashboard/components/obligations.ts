...
export function computeObligations(prop: OblProp, tenant: OblTenant | null, now = new Date()): Obligation[] {
  ...
  push('e1', 'Φορολογική δήλωση (Ε1 & Ε2 μισθωμάτων)', nextAnnual(now, 5, 30), 'financial',
    'Υποβολή δήλωσης εισοδήματος. Το Ε2 δηλώνει τα μισθώματα. Συχνά δίνεται παράταση, επιβεβαίωσε στο myAADE.', 'high');

  // ΕΝΦΙΑ, εκκαθάριση & Α΄ δόση τυπικά τέλη Μαΐου (πληρωμή σε δόσεις έως Φεβ.).
  push('enfia', 'ΕΝΦΙΑ, εκκαθάριση & Α΄ δόση', nextAnnual(now, 4, 31), 'financial',
    prop.enfia ? `Εκτιμώμενο ετήσιο ΕΝΦΙΑ: ${Math.round(prop.enfia)} €. Πληρώνεται σε μηνιαίες δόσεις.` : 'Πληρώνεται σε μηνιαίες δόσεις (τυπικά έως τον Φεβρουάριο του επόμενου έτους).', 'high');
