    ...
    <div>
      <Card>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 220px), 1fr))', gap: 14 }}>
          <TextInput label="Επωνυμία ή όνομα γραφείου" value={companyName} onChange={setCompanyName} placeholder="Παράδειγμα: Παπαδόπουλος Real Estate" />
        ...
        <div style={{ border: '1px solid var(--border-subtle)', borderRadius: 10, overflow: 'hidden', background: '#fff' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '16px 18px', borderBottom: `2px solid ${sanitizeAccent(accent)}` }}>
            ...
            <div>
              ...
              {contact && <div style={{ fontSize: 10, color: '#5f6368', fontFamily: T.font.sans, marginTop: 2 }}>{contact}</div>}
            </div>
          </div>
        </div>
      </Card>
