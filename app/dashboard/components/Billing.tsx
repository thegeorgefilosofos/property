    ...
    <div>
      ...
      <Card>
        ...
        <InfoBanner tone="info">
          Ο λογαριασμός σου ξεκινά με <strong>τριάντα ημέρες δωρεάν δοκιμή</strong>, χωρίς κάρτα. Η πληρωμή με κάρτα ενεργοποιείται πολύ σύντομα· συμπλήρωσε από τώρα τα στοιχεία τιμολόγησης, ώστε η ενεργοποίηση να γίνει με ένα κλικ.
        </InfoBanner>
