...
insert into public.loan_programs (program_id, name, icon, color, status, type_label, description, how_it_works, extra_info, savings_example, max_amount, max_prop_value, max_ltv, max_sqm, age_min, age_max, duration_label, deadline, deadline_label, deadline_urgent, total_budget, criteria, participating_banks, source_url, verified_at) values
 ('spiti_mou_2','Σπίτι μου ΙΙ','home','#1a73e8','active','Κρατικό, άτοκο 50% (75% για τρίτεκνους)','Χρηματοδότηση έως 190.000€ για πρώτη και κύρια κατοικία. Το 50% του δανείου είναι άτοκο (Ταμείο Ανάκαμψης), το υπόλοιπο 50% με επιτόκιο τράπεζας.','50% του δανείου άτοκο (Ταμείο Ανάκαμψης), 50% έντοκο (τράπεζα). Τρίτεκνοι/πολύτεκνοι: 75% άτοκο / 25% έντοκο.','Προθεσμία αίτησης 31/05/2026, σύναψη σύμβασης έως 31/08/2026. Τρίτεκνοι: το άτοκο σκέλος στο 75%.','Δάνειο 150.000€ × 25 έτη με 50% άτοκο: εξοικονόμηση δεκάδων χιλιάδων € σε τόκους.',190000,250000,90,150,25,50,'3 έως 30 έτη (χωρίς περίοδο χάριτος)',date '2026-08-31','Έως 31/08/2026 (αίτηση έως 31/05/2026)',true,'2 δισ. ευρώ (50% Ταμείο Ανάκαμψης + 50% τράπεζες)',array['Ηλικία 25-50 ετών','Πρώτη και κύρια κατοικία','Εισόδημα ενδεικτικά: έγγαμοι 35.000€ +5.000€/παιδί, μονογονεϊκές 39.000€ (επιβεβαίωσε στην πύλη)','Αξία συμβολαίου ≤ 250.000€','Έως 150 τετραγωνικά','Έτος κατασκευής έως και 2007'],array['Εθνική','Alpha','Eurobank','Πειραιώς','Optima','CrediaBank'],'https://stegasi.gov.gr/programs/spiti-mou-ii/',date '2026-07-08'),
