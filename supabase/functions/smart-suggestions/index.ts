...
const AI_LIMITS = {
  perMinute: 20,
  // Σειρά = user_plan_rank: 0 δωρεάν, 1 ένα ακίνητο, 2 ιδιοκτήτης,
  // 3 επαγγελματίας, 4 γραφείο. Με το `solo` να μπαίνει στη θέση 1, ΚΑΘΕ
  // επόμενο όριο μετακινήθηκε — χωρίς αυτό, ο «Ιδιοκτήτης» θα έπαιρνε τα όρια
  // του «Ένα ακίνητο» και ο «Γραφείο» του «Επαγγελματία».
  perDayByRank: [15, 20, 30, 60, 120],
  perMonthByRank: [60, 80, 120, 300, 600],
