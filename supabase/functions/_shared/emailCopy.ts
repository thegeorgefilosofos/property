...
// Δεκαέξι προγράμματα, 106 emails: 1) Onboarding 2) Engagement 3) Upsell
  ...
  feedback_lottery: (c) => ({
    ...
    html: emailShell({
      ...
      bodyHtml: eyebrow('Η γνώμη σου') + h('Η γνώμη σου μετράει, πραγματικά') + greeting(c.name)
        ...
        + button('Πες μας τη γνώμη σου', dash(c))
        + note('Ισχύουν όροι συμμετοχής στην κλήρωση. Θα σου πάρει ένα λεπτό. Διαβάζουμε κάθε απάντηση, μία μία.'),
    }),
  }),
