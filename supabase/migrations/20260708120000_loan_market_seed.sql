...
insert into public.loan_programs (program_id, name, icon, color, status, type_label, description, how_it_works, extra_info, savings_example, max_amount, max_prop_value, max_ltv, max_sqm, age_min, age_max, duration_label, deadline, deadline_label, deadline_urgent, total_budget, criteria, participating_banks, source_url, verified_at) values
 ('spiti_mou_2','Σπίτι μου ΙΙ','home','#1a73e8','active','Κρατικό, άτοκο 50% (+ επιδότηση επιτοκίου για τρίτεκνους/πολύτεκνους)',
   ...
   '50% του δανείου άτοκο (Ταμείο Ανάκαμψης) · 50% έντοκο (τράπεζα) — για ΟΛΟΥΣ. Τρίτεκνοι/πολύτεκνοι: επιπλέον επιδότηση 50% του επιτοκίου στο τραπεζικό σκέλος (το άτοκο κεφάλαιο ΠΑΡΑΜΕΝΕΙ 50%).',
   'Προθεσμία αίτησης 31/05/2026, σύναψη σύμβασης έως 31/08/2026. Τρίτεκνοι/πολύτεκνοι: επιδότηση 50% του επιτοκίου στο τραπεζικό μισό — δεν γίνεται άτοκο το 75% του κεφαλαίου.',
   ...
   array['Ηλικία 25-50 ετών','Πρώτη και κύρια κατοικία','Εισόδημα ενδεικτικά: έγγαμοι 35.000€ +5.000€/παιδί, μονογονεϊκές 39.000€ (επιβεβαίωσε στην πύλη)','Αξία συμβολαίου ≤ 250.000€','Έως 150 τετραγωνικά','Έτος κατασκευής έως και 2007 (για ΑμεΑ ≥67% έως και 31/12/2020)'],
