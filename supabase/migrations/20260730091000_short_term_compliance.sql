...
--    rent_short. 12.145 καταχωρίσεις στάλθηκαν για απενεργοποίηση το 2025
...
comment on column public.user_properties.ama_listed_confirmed_at is
  'Πότε ο ιδιοκτήτης επιβεβαίωσε ότι ο ΑΜΑ ΑΝΑΓΡΑΦΕΤΑΙ στην αγγελία (Airbnb/Booking). Η καταχώριση στο μητρώο δεν αρκεί: το 2025 στάλθηκαν 12.145 καταχωρίσεις για απενεργοποίηση επειδή ο ΑΜΑ έλειπε ή ήταν άκυρος ΣΤΗΝ ΑΓΓΕΛΙΑ. NULL = δηλώθηκε αλλά δεν επιβεβαιώθηκε.';
