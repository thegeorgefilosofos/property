...
//
// ΤΟ ΧΡΕΟΣ ΗΤΑΝ 118 ΠΟΛΙΤΙΚΕΣ ΣΕ 63 ΠΙΝΑΚΕΣ και μηδενίστηκε με το
// `20260808010000_rls_initplan`, που ξαναγράφει τους ΠΡΑΓΜΑΤΙΚΟΥΣ ορισμούς από
// τον κατάλογο. Ο φύλακας υπάρχει για να μην ξαναγεννηθεί μία-μία: κανένα
// build δεν σπάει από αυτό, καμία δοκιμή δεν πέφτει, και το κόστος φαίνεται
// μόνο όταν ο πίνακας έχει ήδη μεγαλώσει — δηλαδή στον πρώτο πραγματικό πελάτη.
//
