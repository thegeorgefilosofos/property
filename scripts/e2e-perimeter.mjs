...
//
//  ΔΥΟ ΔΙΕΥΘΥΝΣΕΙΣ ΧΩΡΙΣ ΣΥΝΕΔΡΙΑ: το webhook του ταχυδρομείου, που φυλάει τον
//  εαυτό του με υπογραφή, και η συνδρομή ημερολογίου, που τον φυλάει με το
//  κουπόνι της διαδρομής. Και οι δύο σπάνε με τον ίδιο σιωπηλό τρόπο: μια
//  ανακατεύθυνση σε φόρμα εισόδου, που κανένα σφάλμα δεν την αναφέρει.
//
//  ΧΡΗΣΗ:
...
console.log(`\n/api/inbound και /imerologio — ${pass} πέρασαν, ${fail} απέτυχαν`)
