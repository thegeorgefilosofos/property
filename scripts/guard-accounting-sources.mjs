...
// ─────────────────────────────────────────────────────────────────────────
// Ένα αρχείο JSON που λέει «είμαστε κλειδωμένοι στην v1.0.4» δεν αξίζει
// τίποτα αν κανείς δεν το συγκρίνει με τον κώδικα. Θα μείνει να λέει v1.0.4
// για πάντα, ενώ ο κώδικας θα έχει πάει αλλού — και θα είναι χειρότερο από το
// να μην υπήρχε, γιατί θα το πιστεύει ο επόμενος.
//
