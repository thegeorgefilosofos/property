...
//           για πυκνούς πίνακες.»
//
// Και παραβιαζόταν σε σαράντα πέντε σημεία, σε δεκατέσσερα αρχεία: αριθμοί
// ΜΕΣΑ σε τρέχουσα πρόταση γραμμένοι σε monospace. Το αποτέλεσμα δεν είναι απλώς
...
// τιμολογίου ρεύματος, έξι γραμμές είχαν σε monospace και την ΕΤΙΚΕΤΑ —
// «Χρέωση ημέρας», «Μηνιαίο πάγιο» — με τη στοίχιση να γίνεται με δύο
// κυριολεκτικά κενά. Η κάρτα διαβαζόταν σαν έξοδος τερματικού μέσα σε premium
// οθόνη.
//
