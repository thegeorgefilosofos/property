...
//
// ΚΑΣΤΑΝΙΑ, ΟΧΙ ΤΕΙΧΟΣ. Το μοτίβο υπάρχει σε δεκάδες οθόνες γραμμένο με το
// χέρι. Ένας φύλακας που θα απαιτούσε να διορθωθούν όλες σήμερα θα
// παρακαμπτόταν αύριο. Ο αριθμός καταγράφεται και ΜΟΝΟ κατεβαίνει.
//
