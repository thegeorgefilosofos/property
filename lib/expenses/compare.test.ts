...
// ═══ Η ΕΠΙΚΕΦΑΛΙΔΑ ΔΕΝ ΕΠΑΝΑΛΑΜΒΑΝΕΙ ΤΙΣ ΚΑΤΗΓΟΡΙΕΣ ══════════════════════
...
// απόσταση. Η ειδοποίηση όμως δεν έχει ράβδους, γι' αυτό κρατά την πλήρη φράση.
{
  const data = [s('2026-06-10', 100, 'electricity'), s('2026-07-10', 160, 'electricity')];
  const c = compareMonth(data, '2026-07', { today: JUL31 });
  ok('η πλήρης φράση απαριθμεί την κατηγορία', c.sentence.includes('Κυρίως από'));
  ok('η επικεφαλίδα ΔΕΝ την απαριθμεί', !c.headline.includes('Κυρίως'));
  ok('η επικεφαλίδα κρατά το ποσό και την κατεύθυνση',
     c.headline.includes('60,00 €') && c.headline.includes('περισσότερα'));
