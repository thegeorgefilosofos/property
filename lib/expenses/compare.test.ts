...
//    σωστό και εντελώς ψεύτικο.
{
  ...
  // ΚΑΙ ΟΧΙ ΔΕΥΤΕΡΗ ΦΟΡΑ ΣΤΗ ΦΡΑΣΗ. Η επιφύλαξη το λέει με τον μήνα και τις
  // ημέρες· η φράση το έλεγε ξανά, γυμνό· οι δύο προτάσεις εμφανίζονταν
  // μαζί σε κάθε καταναλωτή τους (κάρτα και ειδοποίηση).
  ok('και όχι δεύτερη φορά στη φράση', !c.sentence.includes('δεν έχει τελειώσει'));
  ok('η ειδοποίηση το λέει ΜΙΑ φορά',
    (monthlyDigest(data, new Date(2026, 6, 12))?.match(/δεν έχει τελειώσει/g) ?? []).length === 1);
}
