...
export const RENTAL_TAX_ROWS_2026: { range: string; rate: string; from: number; to: number }[] = [
  { range: '0 – 12.000 €',      rate: taxRateLabel(RENTAL_TAX_BRACKETS_2026[0].rate), from: 0,     to: 12000 },
  { range: '12.001 – 24.000 €', rate: taxRateLabel(RENTAL_TAX_BRACKETS_2026[1].rate), from: 12000, to: 24000 },
  { range: '24.001 – 35.000 €', rate: taxRateLabel(RENTAL_TAX_BRACKETS_2026[2].rate), from: 24000, to: 35000 },
  { range: 'Πάνω από 35.000 €', rate: taxRateLabel(RENTAL_TAX_BRACKETS_2026[3].rate), from: 35000, to: Infinity },
];
