...
export const PLANS: Record<PlanId, Plan> = {
  ...
  free: {
    ...
    features: ['Τα δεδομένα σου παραμένουν ανέπαφα', 'Χωρίς τα φορολογικά του «Ιδιοκτήτη»'],
  },
  // ═══════════════════════════════════════════════════════════════════════
  ...
  solo: {
    ...
    features: [
      'Ε2 προσυμπληρωμένο, έτοιμο για τον λογιστή',
      'Έλεγχος Δήλωσης Μίσθωσης πριν το myAADE',
      'ΕΝΦΙΑ: υπολογισμός, έκπτωση ασφάλισης, δόσεις',
      'Ενοικιαστής, εισπράξεις και οφειλές',
      'Σάρωση λογαριασμών με φωτογραφία',
    ],
  },
  ...
  owner: {
    ...
    features: [
      ...
      'Διπλάσιο πακέτο ερωτήσεων στον βοηθό',
      'Το mobile app 15 ημέρες νωρίτερα',
    ],
  },
  ...
  agency: {
    ...
    features: [
      ...
      'Λογιστικό ημερολόγιο και κινήσεις τράπεζας',
  ...
  office: {
    ...
    features: [
      'Απεριόριστα ακίνητα, χωρίς χρέωση ανά ακίνητο',
      'Ομάδα χωρίς όριο χρηστών',
      'Το μεγαλύτερο πακέτο ερωτήσεων στον βοηθό',
      'Κάθε νέα δυνατότητα πρώτα σε εσένα',
