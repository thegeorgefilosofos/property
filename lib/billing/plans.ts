...
export const PLANS: Record<PlanId, Plan> = {
  free: {
    ...
    tagline: 'Για τον ιδιοκτήτη με ένα ακίνητο',
    features: ['1 ακίνητο, κάθε τύπου', 'Σάρωση με φωτογραφία και βοηθός με φωνή', 'Αποδόσεις, δαπάνες, ενέργεια, φορολογία', 'Έξυπνες ειδοποιήσεις και υπενθυμίσεις'],
  },
  owner: {
    id: 'owner', name: 'Ιδιοκτήτης', priceMonthly: 6.9, priceAnnual: 59, maxProperties: 15,
    tagline: 'Για χαρτοφυλάκιο, ενοικιαστές και Airbnb',
    features: ['Έως 15 ακίνητα, όλων των τύπων', 'Όλα όσα έχει το δωρεάν, χωρίς όρια', 'Συγκρίσεις μεταξύ των ακινήτων σου', 'Φορολογικές εξαγωγές έτοιμες για τον λογιστή', 'Προτεραιότητα στη σάρωση και στον βοηθό'],
  },
  agency: {
    id: 'agency', name: 'Επαγγελματίας', priceMonthly: 19, priceAnnual: 190, maxProperties: Infinity,
    tagline: 'Για μεσιτικά γραφεία και διαχειριστές ακινήτων',
    features: ['Απεριόριστα ακίνητα', 'Πολλοί χρήστες στην ίδια ομάδα', 'Αναφορές με τη δική σου επωνυμία', 'Υποστήριξη κατά προτεραιότητα'],
  },
};
