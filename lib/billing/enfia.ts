...
/** Γιατί δεν βγαίνει εκτίμηση: γήπεδο (άλλος πίνακας) ή βοηθητικός χώρος. */
export type EnfiaTypeBlock = 'land' | 'auxiliary'
...
export const ENFIA_TYPE_BLOCK_NOTE: Record<EnfiaTypeBlock, string> = {
  ...
  auxiliary: 'Οι βοηθητικοί χώροι (αποθήκη, θέση στάθμευσης) έχουν δικό τους συντελεστή, που δεν υπάρχει στην εφαρμογή. Δεν βγαίνει αυτόματη εκτίμηση.',
}
...
export function enfiaTypeBlock(propType: string | null | undefined): EnfiaTypeBlock | null {
  ...
  if (t === 'parking' || t === 'storage' || t === 'warehouse') return 'auxiliary'
