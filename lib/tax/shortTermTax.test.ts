...
const sumLarge = shortTermYearSummary(stays, 2026, { sqm: 120 });
...
ok('net αφαιρεί τέλος παρεπ.', Math.abs(shortTermYearSummary(stays, 2026, { sqm: 120 }).net - (1500 - rentalIncomeTax(1500) - 98 - 7.5)) < 0.01);
