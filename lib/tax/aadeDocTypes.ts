...
//
// ΔΥΟ ΤΥΠΟΓΡΑΦΙΚΑ ΤΗΣ ΠΗΓΗΣ, ΔΙΟΡΘΩΜΕΝΑ ΡΗΤΑ:
//   · Το φύλλο 1.5 γράφει «catΕgory2_3» με ελληνικό «Ε». Αντιγραμμένο αυτούσιο,
//     θα ταξίδευε ως άγνωστος κωδικός σε κάθε σύγκριση.
//   · Το φύλλο 14.2 τιτλοφορείται «Τιμολόγιο / Ενδοκοινοτικές Αποκτήσεις»,
//     δηλαδή ΑΚΡΙΒΩΣ όπως το 14.1. Είναι αντιγραφή της προηγούμενης σελίδας: ο
//     14.2 είναι οι αποκτήσεις ΤΡΙΤΩΝ ΧΩΡΩΝ, όπως ο 14.4 είναι η λήψη υπηρεσιών
//     τρίτων χωρών απέναντι στον ενδοκοινοτικό 14.3. Αφημένο αυτούσιο, το ίδιο
//     βιβλίο ονόμαζε τον ίδιο τύπο με δύο τρόπους σε δύο φύλλα του.
// Και τα δύο τα επιβάλλει το τεστ.
// ═══════════════════════════════════════════════════════════════════════════
...
export const AADE_DOC_TYPES: Record<string, AadeDocType> = {
  ...
  '14.2': { title: 'Τιμολόγιο / Αποκτήσεις Τρίτων Χωρών', income: [], expense: ['category2_1', 'category2_2', 'category2_4', 'category2_5', 'category2_7', 'category2_10', 'category2_11', 'category2_95'] },
