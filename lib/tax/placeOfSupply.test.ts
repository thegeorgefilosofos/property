...
// ΤΟ ΟΝΟΜΑ ΛΕΕΙ ΤΟΝ ΤΟΠΟ, ΟΧΙ ΤΟ ΕΜΠΟΡΕΥΜΑ. Η ίδια στήλη δέχεται και αγαθά: με
// «λήψη υπηρεσιών» στο όνομα, ένας καναπές από την Ιταλία έβγαινε στο Excel του
// λογιστή ως υπηρεσία, δίπλα σε τύπο παραστατικού που έλεγε «απόκτηση αγαθών».
ok(supplyLabel('intra_eu') === 'Ενδοκοινοτική λήψη', 'ολόκληρο το όνομα, όχι συντομογραφία');
ok(!supplyLabel('intra_eu').includes('υπηρεσι') && !supplyLabel('third_country').includes('υπηρεσι'),
  'κανένα όνομα δεν προδικάζει αν ελήφθη υπηρεσία ή αγαθό');
ok(supplyLabel('third_country') === 'Λήψη από τρίτη χώρα', 'η τρίτη χώρα λέγεται ολόκληρη');
