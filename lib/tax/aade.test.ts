...
// ═══ ΟΙ ΡΙΖΕΣ ΕΙΝΑΙ ΑΥΤΕΣ ΠΟΥ ΕΠΑΛΗΘΕΥΤΗΚΑΝ ══════════════════════════════
// Δύο διορθώθηκαν αφού ελέγχθηκαν σε δημοσιευμένες πηγές (ο διακομιστής
// μεσολάβησης απορρίπτει το aade.gr και το gov.gr, οπότε δεν ανοίγει καμία
// απευθείας): η πύλη είναι το myaade.gov.gr και όχι εσωτερική διεύθυνση
// εφαρμογής και οι αντικειμενικές αξίες έχουν δική τους εφαρμογή χάρτη.
// Γραμμένο ως έλεγχος, ώστε να μη γυρίσει σιωπηλά η παλιά τιμή.
{
  eq('η πύλη είναι η δημόσια διεύθυνση του πολίτη', MYAADE, 'https://www.myaade.gov.gr')
  ok('καμία εσωτερική διεύθυνση εφαρμογής', !/aadeapps\d/.test(JSON.stringify(AADE_DESTINATIONS)))
  eq('οι αντικειμενικές αξίες πάνε στην εφαρμογή χάρτη',
    AADE_DESTINATIONS['objective-values'].url, 'https://www.valuemaps.gov.gr')
}
