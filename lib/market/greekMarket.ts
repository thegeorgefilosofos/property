...
export const REGIONS: RegionYield[] = [
  ...
  { key: 'sporades', label: 'Σκιάθος / Σκόπελος', region: 'Θεσσαλία', pricePerSqm: [1800, 3000], rentPerSqm: [8, 12], grossYield: 5.0, tags: ['island', 'tourist', 'airport'], note: 'Σποράδες με αεροδρόμιο (Σκιάθος): ισχυρός τουρισμός πακέτων, έντονη εποχικότητα. Πρόσβαση από Βόλο/Άγιο Κωνσταντίνο.' },
