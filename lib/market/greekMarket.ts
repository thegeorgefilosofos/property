...
export const REGIONS: RegionYield[] = [
  ...
  { key: 'ath_center', label: 'Κέντρο Αθήνας', region: 'Αττική', pricePerSqm: [2100, 3800], rentPerSqm: [10, 16], grossYield: 5.0, tags: ['center', 'metro', 'city'], note: 'Κυψέλη 5,4% έως 7,3% · Εξάρχεια περίπου 4,9% · Παγκράτι περίπου 4,3% · Κουκάκι 3% έως 4,4% (κορεσμός βραχυχρόνιας). Οι φθηνότερες και κεντρικές αποδίδουν περισσότερο.' },
...
export const HISTORY_ANCHORS = {
  ...
  note: 'Από την κορυφή του 2008 στον πυθμένα του 2017: −42% (ονομαστικά, −48% πραγματικά). Ανάκαμψη από τον πυθμένα περίπου 95% ως το 2026. Οι πρόσφατες ανατιμήσεις αποκλιμακώνονται (από +13,9% το 2023 σε +5,7% το πρώτο τρίμηνο του 2026).',
}
...
export const YIELD_LEVERS: YieldLever[] = [
  {
    ...
    impact: 'Τιμή έως 35% κάτω από την εκτιμηθείσα ανεβάζει τη μεικτή απόδοση περίπου κατά το ένα τρίτο: από 5,00% σε περίπου 6,70%.',
  ...
  },
  {
    ...
    impact: 'Όταν η καθαρή απόδοση ξεπερνά το κόστος του δανείου, η απόδοση των δικών σου κεφαλαίων ανεβαίνει: με δανεισμό 70,00%, απόδοση 5,00% και επιτόκιο 3,00%, φτάνει περίπου στο 9,70%.',
...
export const AUCTION_FACTS = {
  ...
  completionRate: 14, // περίπου 1 στους 7 βρίσκει αγοραστή
