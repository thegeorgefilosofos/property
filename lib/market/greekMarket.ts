...
export const REGIONS: RegionYield[] = [
  ...
  { key: 'ath_kolonaki', label: 'Κολωνάκι (προνομιακή ζώνη)', region: 'Αττική', pricePerSqm: [4500, 8900], rentPerSqm: [15, 22], grossYield: 3.7, tags: ['center', 'metro', 'city'], typicalPerSqm: 5400, note: 'Προνομιακό κέντρο (~5.400 € ανά τετραγωνικό): υψηλές αξίες, χαμηλή % απόδοση αλλά ισχυρή διατήρηση αξίας και ζήτηση Golden Visa.' },
  { key: 'ath_south', label: 'Νότια προάστια', region: 'Αττική', pricePerSqm: [3700, 7600], rentPerSqm: [13, 21], grossYield: 3.6, tags: ['suburb', 'metro'], note: 'Γλυφάδα 3,8% · Βούλα 3,3% · Ελληνικό 3,5%: το ακριβότερο της Ελλάδας (Βουλιαγμένη ~7.586 € ανά τετραγωνικό). Χαμηλή % απόδοση, κορυφαία ανατίμηση (The Ellinikon).' },
  ...
  // ── Θεσσαλία ──
  { key: 'larissa', label: 'Λάρισα', region: 'Θεσσαλία', pricePerSqm: [1170, 1335], rentPerSqm: [8, 9], grossYield: 7.0, tags: ['city'], note: 'Από τις υψηλότερες αποδόσεις Ελλάδας: πολύ χαμηλές τιμές (~1.333 € ανά τετραγωνικό), ενοίκια που ανεβαίνουν ταχύτερα, φοιτητές/νοσοκομείο.' },
  ...
  // ── Δυτική Ελλάδα ──
  { key: 'patras', label: 'Πάτρα', region: 'Δυτική Ελλάδα', pricePerSqm: [1300, 1700], rentPerSqm: [8, 9], grossYield: 5.9, tags: ['city', 'port'], note: 'Πανεπιστήμιο Πατρών + λιμάνι Αδριατικής: μεγάλη φοιτητική ζήτηση, ~1.646 € ανά τετραγωνικό, απόδοση 5–7%.' },
  ...
  { key: 'mykonos', label: 'Μύκονος', region: 'Νότιο Αιγαίο', pricePerSqm: [5500, 12000], rentPerSqm: [17, 26], grossYield: 2.9, tags: ['island', 'tourist'], typicalPerSqm: 7574, note: 'Κορυφαία εμπορική αξία (~7.574 € ανά τετραγωνικό)· η μακροχρόνια % πολύ χαμηλή, αλλά έσοδα βραχυχρόνιας €40–70 χιλιάδες τον χρόνο με ακραία εποχικότητα.' },
  { key: 'santorini', label: 'Σαντορίνη (Θήρα)', region: 'Νότιο Αιγαίο', pricePerSqm: [4200, 7500], rentPerSqm: [15, 22], grossYield: 3.8, tags: ['island', 'tourist'], typicalPerSqm: 4810, note: 'Παγκοσμίως αναγνωρίσιμη καλντέρα (~4.810 € ανά τετραγωνικό)· υψηλές αξίες, ισχυρή βραχυχρόνια, χαμηλή μακροχρόνια απόδοση.' },
  ...
  // ── Κρήτη ──
  { key: 'heraklion', label: 'Ηράκλειο', region: 'Κρήτη', pricePerSqm: [1550, 2100], rentPerSqm: [8, 10], grossYield: 5.7, tags: ['island', 'city', 'airport', 'port'], note: 'Πανεπιστήμιο Κρήτης, αεροδρόμιο+λιμάνι: από τις κορυφαίες αποδόσεις (5,2–6,4%), χαμηλές τιμές + σταθερά ενοίκια.' },
  { key: 'chania', label: 'Χανιά', region: 'Κρήτη', pricePerSqm: [2400, 3200], rentPerSqm: [8, 11], grossYield: 3.9, tags: ['island', 'tourist', 'airport'], note: 'Από τις ακριβότερες περιοχές: χαμηλότερη ΜΑΚΡΟΧΡΟΝΙΑ απόδοση, αλλά βραχυχρόνια/τουριστικά 8–11% (Παλιά Πόλη).' },
...
export const YIELD_LEVERS: YieldLever[] = [
  {
    ...
    impact: 'Έως −35% της εκτιμηθείσας αξίας → αύξηση μεικτής απόδοσης ~+33% σχετικά (για παράδειγμα 5,0% → ~6,7%).',
  ...
  },
  {
    ...
    impact: 'Όταν η καθαρή απόδοση ξεπερνά το κόστος του δανείου, η απόδοση των δικών σου κεφαλαίων ανεβαίνει. Με δανεισμό 70%, απόδοση 5% και επιτόκιο 3%, από 5% πάει περίπου στο 9,7%.',
  ...
  },
  {
    ...
    impact: 'Έως 16.000,00 € έκπτωση φόρου σε πέντε έτη, δηλαδή 3.200,00 € τον χρόνο. Επιδοτεί την αναβάθμιση που δικαιολογεί υψηλότερο ενοίκιο.',
  ...
  },
  {
    ...
    impact: 'Επιδότηση 60% του κόστους ανακαίνισης, έως 8.100,00 €, για κενή κατοικία που μπαίνει σε μακροχρόνια μίσθωση τουλάχιστον τριών ετών.',
    detail: 'Προϋποθέσεις: το ακίνητο δηλωμένο κενό στο έντυπο Ε2, εμβαδόν έως 100 τετραγωνικά, εισόδημα έως περίπου 40.000,00 € και συνολική ακίνητη περιουσία έως 300.000,00 €. Μετατρέπει ένα ακίνητο που δεν αποδίδει σε εισόδημα, με τα έξη δέκατα του κόστους καλυμμένα.',
  ...
  },
  {
    ...
    impact: 'Μείωση ΕΝΦΙΑ κατά 20% για ακίνητα αξίας έως 500.000,00 €, ή κατά 10% για μεγαλύτερη αξία, με ένα φθηνό ασφαλιστήριο τριών κινδύνων.',
  ...
  },
  {
    ...
    impact: 'Διατηρεί την τεκμαρτή έκπτωση του 5%, δηλαδή ο φόρος υπολογίζεται στο 95% του ενοικίου αντί για το 100%. Αυξάνει αμέσως την καθαρή απόδοση.',
