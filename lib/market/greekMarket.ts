...
export const HISTORY_ANCHORS = {
  ...
  note: 'Από την κορυφή του 2008 στον πυθμένα του 2017: −42% (ονομαστικά, −48% πραγματικά). Ανάκαμψη από τον πυθμένα ~+95% ως το 2026. Οι πρόσφατες ανατιμήσεις αποκλιμακώνονται (από +13,9% το 2023 σε +5,7% το πρώτο τρίμηνο του 2026).',
}
...
export const YIELD_LEVERS: YieldLever[] = [
  {
    ...
    impact: 'Έως −35% της εκτιμηθείσας αξίας δίνει αύξηση μεικτής απόδοσης ~+33% σχετικά (για παράδειγμα από 5,0% σε ~6,7%).',
    detail: 'Στο eauction.gr, μέσω συμβολαιογράφου. Μετά από 2 άγονους η τιμή πέφτει αυτόματα στο 80%, μετά τον 3ο στο 65%. Μόνο ~1 στους 7 βρίσκει αγοραστή, άρα πλεόνασμα προσφοράς.',
  ...
  },
  {
    ...
    detail: 'Προϋποθέσεις: το ακίνητο δηλωμένο κενό στο έντυπο Ε2, εμβαδόν έως 100 τετραγωνικά, εισόδημα έως περίπου 40.000,00 € και συνολική ακίνητη περιουσία έως 300.000,00 €. Μετατρέπει ένα ακίνητο που δεν αποδίδει σε εισόδημα, με τα έξι δέκατα του κόστους καλυμμένα.',
