...
//
// ΤΟ ΠΡΟΒΛΗΜΑ, ΜΕΤΡΗΜΕΝΟ. Το 2025 στάλθηκαν **12.145 καταχωρίσεις για
...
export const AMA_COPY: Record<Exclude<AmaState, 'not_required'>, { title: string; body: string; tone: 'negative' | 'warning' | 'positive' }> = {
  missing: {
    title: 'Λείπει ο ΑΜΑ',
    tone: 'negative',
    body: 'Το ακίνητο είναι σε βραχυχρόνια μίσθωση, άρα χρειάζεται Αριθμό Μητρώου Ακινήτου από το Μητρώο Ακινήτων Βραχυχρόνιας Διαμονής (myAADE). Το 2025 στάλθηκαν 12.145 καταχωρίσεις για απενεργοποίηση επειδή ο ΑΜΑ έλειπε ή ήταν άκυρος.',
  },
  unconfirmed: {
    title: 'Ο ΑΜΑ δηλώθηκε — αναγράφεται στην αγγελία;',
    tone: 'warning',
    body: 'Η εγγραφή στο μητρώο δεν αρκεί: ο ΑΜΑ πρέπει να φαίνεται σε ΚΑΘΕ καταχώριση (Airbnb, Booking). Άνοιξε την αγγελία σου, δες ότι είναι εκεί, και επιβεβαίωσέ το.',
  },
  ok: {
    title: 'ΑΜΑ δηλωμένος και επιβεβαιωμένος στην αγγελία',
    tone: 'positive',
    body: 'Επιβεβαίωσέ το ξανά αν αλλάξεις ή δημιουργήσεις καταχώριση.',
  },
};
