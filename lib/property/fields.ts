...
export const PROPERTY_FIELDS: readonly FieldRule[] = [
  ...
  { id: 'prop.floor', label: 'Οροφος', why: 'Επηρεάζει τον συντελεστή ΕΝΦΙΑ και την τιμή ενοικίασης.', when: c => !isLand(c), rare: true },
  { id: 'prop.year_built', label: 'Ετος κατασκευής', why: 'Κρίνει την παλαιότητα στον ΕΝΦΙΑ και το ασφάλιστρο.', when: c => !isLand(c), rare: true },
  ...
  { id: 'prop.enfia', label: 'Εκτιμώμενος ΕΝΦΙΑ', why: 'Δικός σου αριθμός για όσο δεν έχει έρθει το εκκαθαριστικό.', rare: true },
  { id: 'prop.ownership', label: 'Ποσοστό ιδιοκτησίας', why: 'Κόβει έσοδα, δαπάνες και φόρο στο δικό σου μερίδιο.', rare: true },
