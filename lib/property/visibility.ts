...
const BY_STATUS: Record<string, readonly PropertyStatus[]> = {
  ...
  clients: ['rent_short'],
  pricing: ['rent_short'],
  // Οι αποδόσεις έχουν νόημα όπου υπάρχει ή μπορεί να υπάρξει έσοδο. Στην
  // ιδιοχρησία δεν υπάρχει απόδοση να μετρηθεί: το σπίτι δεν αποδίδει, το
  // κατοικείς. Ένα «0% απόδοση» εκεί δεν είναι πληροφορία, είναι κατηγορία.
  roi:     ['rent_long', 'rent_short', 'vacant', 'for_sale'],
