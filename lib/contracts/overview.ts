...
export const CONTRACT_EMPTY_HINT: Record<ContractKind, string> = {
  ...
  gas: 'Ανέβασε έναν λογαριασμό αερίου, ή δήλωσε τον τρόπο θέρμανσης αν δεν έχεις αέριο',
  ...
  services: 'Υπολόγισε τον ΕΝΦΙΑ και κατέγραψε τα δημοτικά τέλη και τις υπηρεσίες του ακινήτου',
};
