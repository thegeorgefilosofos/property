...
// ═══════════════════════════════════════════════════════════════════════════
// PROPERTY OS — ο ΜΟΝΑΔΙΚΟΣ υποδοχέας επιβεβαίωσης.
...
// Το κείμενο του κόκκινου κουμπιού παίρνει το χρώμα ΦΟΝΤΟΥ της εφαρμογής, όχι
// σκέτο λευκό: στο σκούρο θέμα το --negative είναι ανοιχτό τριανταφυλλί και
// λευκά γράμματα πάνω του δεν διαβάζονται· στο ανοιχτό θέμα είναι σκούρο
// κεραμιδί και θέλει ανοιχτά. Το --bg-base αντιστρέφεται μαζί με το θέμα, άρα
// δίνει αντίθεση και στα δύο χωρίς δεύτερη μεταβλητή.
const btnDanger: CSSProperties = { background: 'var(--negative)', color: 'var(--bg-base)' };
